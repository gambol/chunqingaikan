package android.support.v4.view; class PagerTabStrip$2 { void a() { int a;
a=0;// .class Landroid/support/v4/view/PagerTabStrip$2;
...
a=0;//     .prologue
a=0;//     .line 111
a=0;//     iput-object p1, p0, Landroid/support/v4/view/PagerTabStrip$2;->this$0:Landroid/support/v4/view/PagerTabStrip;
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Landroid/support/v4/view/PagerTabStrip$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 114
a=0;//     iget-object v0, p0, Landroid/support/v4/view/PagerTabStrip$2;->this$0:Landroid/support/v4/view/PagerTabStrip;
a=0;// 
...
a=0;// 
a=0;//     iget-object v1, p0, Landroid/support/v4/view/PagerTabStrip$2;->this$0:Landroid/support/v4/view/PagerTabStrip;
a=0;// 
