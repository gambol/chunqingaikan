...
a=0;// 
a=0;//     #v4=(Integer);
a=0;//     iput v4, p0, Landroid/support/v4/app/FragmentTabHost;->mContainerId:I
a=0;// 
a=0;//     .line 143
...
a=0;// 
a=0;//     .line 149
a=0;//     invoke-virtual {p0, v10}, Landroid/support/v4/app/FragmentTabHost;->findViewById(I)Landroid/view/View;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
...
a=0;//     invoke-virtual {p0, v2, v4}, Landroid/support/v4/app/FragmentTabHost;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
a=0;// 
a=0;//     .line 156
...
a=0;//     #v1=(Reference,Landroid/widget/FrameLayout;);
a=0;//     iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->mRealTabContent:Landroid/widget/FrameLayout;
a=0;// 
a=0;//     .line 168
a=0;//     iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->mRealTabContent:Landroid/widget/FrameLayout;
a=0;// 
a=0;//     iget v5, p0, Landroid/support/v4/app/FragmentTabHost;->mContainerId:I
a=0;// 
a=0;//     #v5=(Integer);
