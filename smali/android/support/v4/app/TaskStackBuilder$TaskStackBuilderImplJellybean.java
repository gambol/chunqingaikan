package android.support.v4.app; class TaskStackBuilder$TaskStackBuilderImplJellybean { void a() { int a;
a=0;// .class Landroid/support/v4/app/TaskStackBuilder$TaskStackBuilderImplJellybean;
...
a=0;//     accessFlags = 0x8
a=0;//     name = "TaskStackBuilderImplJellybean"
a=0;// .end annotation
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;// 
a=0;//     #p0=(Reference,Landroid/support/v4/app/TaskStackBuilder$TaskStackBuilderImplJellybean;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     .line 103
a=0;//     invoke-static {p1, p3, p2, p4, p5}, Landroid/support/v4/app/TaskStackBuilderJellybean;->getActivitiesPendingIntent(Landroid/content/Context;I[Landroid/content/Intent;ILandroid/os/Bundle;)Landroid/app/PendingIntent;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
