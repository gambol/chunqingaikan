package android.support.v13.app; class FragmentTabHost$DummyTabFactory { void a() { int a;
a=0;// .class Landroid/support/v13/app/FragmentTabHost$DummyTabFactory;
...
a=0;// 
a=0;//     .line 70
a=0;//     #p0=(Reference,Landroid/support/v13/app/FragmentTabHost$DummyTabFactory;);
a=0;//     iput-object p1, p0, Landroid/support/v13/app/FragmentTabHost$DummyTabFactory;->mContext:Landroid/content/Context;
a=0;// 
a=0;//     .line 71
a=0;//     return-void
a=0;// .end method
...
a=0;//     iget-object v1, p0, Landroid/support/v13/app/FragmentTabHost$DummyTabFactory;->mContext:Landroid/content/Context;
a=0;// 
