package safiap.framework; class b { void a() { int a;
a=0;// .class public Lsafiap/framework/b;
...
a=0;//     value = {
a=0;//         Lsafiap/framework/b$d;,
a=0;//         Lsafiap/framework/b$c;,
a=0;//         Lsafiap/framework/b$b;,
a=0;//         Lsafiap/framework/b$a;
a=0;//     }
a=0;// .end annotation
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     .line 20
a=0;//     #p0=(Reference,Lsafiap/framework/b;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;// # virtual methods
a=0;// .method public a(Ljava/lang/String;Z)Z
a=0;//     .locals 4
a=0;// 
a=0;//     .prologue
a=0;//     .line 1613
