package safiap.framework; class h { void a() { int a;
a=0;// .class final Lsafiap/framework/h;
...
a=0;// 
a=0;//     #p0=(Reference,Lsafiap/framework/h;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;// # virtual methods
a=0;// .method public final a(Landroid/os/Message;)V
a=0;//     .locals 5
a=0;// 
a=0;//     .prologue
