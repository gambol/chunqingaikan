package cn.waps; class w { void a() { int a;
a=0;// .class Lcn/waps/w;
...
a=0;//     .locals 0
a=0;// 
a=0;//     iput-object p1, p0, Lcn/waps/w;->a:Lcn/waps/AppConnect;
a=0;// 
a=0;//     invoke-direct {p0}, Landroid/os/AsyncTask;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcn/waps/w;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .locals 0
a=0;// 
a=0;//     invoke-direct {p0, p1}, Lcn/waps/w;-><init>(Lcn/waps/AppConnect;)V
a=0;// 
a=0;//     #p0=(Reference,Lcn/waps/w;);
a=0;//     return-void
a=0;// .end method
...
a=0;//     iget-object v2, p0, Lcn/waps/w;->a:Lcn/waps/AppConnect;
a=0;// 
...
a=0;// 
a=0;//     iget-object v1, p0, Lcn/waps/w;->a:Lcn/waps/AppConnect;
a=0;// 
...
a=0;// 
a=0;//     invoke-static {}, Lcn/waps/al;->u()Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v2
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
a=0;//     move-result-object v2
a=0;// 
a=0;//     iget-object v3, p0, Lcn/waps/w;->a:Lcn/waps/AppConnect;
a=0;// 
a=0;//     invoke-static {v3}, Lcn/waps/AppConnect;->j(Lcn/waps/AppConnect;)Ljava/lang/String;
a=0;// 
...
a=0;//     iget-object v3, p0, Lcn/waps/w;->a:Lcn/waps/AppConnect;
a=0;// 
a=0;//     invoke-static {v3}, Lcn/waps/AppConnect;->k(Lcn/waps/AppConnect;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v3
a=0;// 
a=0;//     invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
a=0;// 
a=0;//     iget-object v0, p0, Lcn/waps/w;->a:Lcn/waps/AppConnect;
a=0;// 
...
a=0;// 
a=0;//     const-string v3, "failed_to_award_points"
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lcn/waps/w;->a([Ljava/lang/Void;)Ljava/lang/Boolean;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/Boolean;);
