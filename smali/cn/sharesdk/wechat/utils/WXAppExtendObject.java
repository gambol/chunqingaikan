package cn.sharesdk.wechat.utils; class WXAppExtendObject { void a() { int a;
a=0;// .class public Lcn/sharesdk/wechat/utils/WXAppExtendObject;
...
a=0;// 
a=0;//     #p0=(Reference,Lcn/sharesdk/wechat/utils/WXAppExtendObject;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,Lcn/sharesdk/wechat/utils/WXAppExtendObject;);
a=0;//     iput-object p1, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->extInfo:Ljava/lang/String;
a=0;// 
a=0;//     iput-object p2, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->filePath:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     iput-object p1, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->extInfo:Ljava/lang/String;
a=0;// 
a=0;//     iput-object p2, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->fileData:[B
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     iget-object v1, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->extInfo:Ljava/lang/String;
a=0;// 
...
a=0;//     :cond_0
a=0;//     #v1=(Conflicted);
a=0;//     iget-object v1, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->filePath:Ljava/lang/String;
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;//     :cond_1
a=0;//     #v1=(Conflicted);
a=0;//     iget-object v1, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->fileData:[B
a=0;// 
a=0;//     #v1=(Reference,[B);
...
a=0;//     :cond_2
a=0;//     #v1=(Conflicted);
a=0;//     const-string v1, "checkArgs fail, all arguments is null"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;// 
a=0;//     const-string v1, "checkArgs fail, extInfo is invalid"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     new-array v2, v0, [Ljava/lang/Object;
a=0;// 
...
a=0;// 
a=0;//     const-string v1, "checkArgs fail, filePath is invalid"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     new-array v2, v0, [Ljava/lang/Object;
a=0;// 
...
a=0;//     iget-object v2, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->filePath:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     iput-object v0, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->extInfo:Ljava/lang/String;
a=0;// 
a=0;//     const-string v0, "_wxappextendobject_fileData"
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->fileData:[B
a=0;// 
a=0;//     const-string v0, "_wxappextendobject_filePath"
a=0;// 
a=0;//     invoke-virtual {p1, v0}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, p0, Lcn/sharesdk/wechat/utils/WXAppExtendObject;->filePath:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
}}
