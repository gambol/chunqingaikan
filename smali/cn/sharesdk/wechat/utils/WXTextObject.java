package cn.sharesdk.wechat.utils; class WXTextObject { void a() { int a;
a=0;// .class public Lcn/sharesdk/wechat/utils/WXTextObject;
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     invoke-direct {p0, v0}, Lcn/sharesdk/wechat/utils/WXTextObject;-><init>(Ljava/lang/String;)V
a=0;// 
a=0;//     #p0=(Reference,Lcn/sharesdk/wechat/utils/WXTextObject;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,Lcn/sharesdk/wechat/utils/WXTextObject;);
a=0;//     iput-object p1, p0, Lcn/sharesdk/wechat/utils/WXTextObject;->text:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     iget-object v1, p0, Lcn/sharesdk/wechat/utils/WXTextObject;->text:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     iput-object v0, p0, Lcn/sharesdk/wechat/utils/WXTextObject;->text:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
}}
