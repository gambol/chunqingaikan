package cn.sharesdk.framework.statistics.b; class a { void a() { int a;
a=0;// .class public Lcn/sharesdk/framework/statistics/b/a;
...
a=0;// 
a=0;//     #p0=(Reference,Lcn/sharesdk/framework/statistics/b/a;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .locals 0
a=0;// 
a=0;//     sput-wide p1, Lcn/sharesdk/framework/statistics/b/a;->d:J
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .locals 2
a=0;// 
a=0;//     sget v0, Lcn/sharesdk/framework/statistics/b/a;->c:I
a=0;// 
a=0;//     #v0=(Integer);
...
a=0;//     .locals 2
a=0;// 
a=0;//     sget-wide v0, Lcn/sharesdk/framework/statistics/b/a;->d:J
a=0;// 
a=0;//     #v0=(LongLo);v1=(LongHi);
a=0;//     return-wide v0
a=0;// .end method
...
a=0;// 
a=0;//     sput v0, Lcn/sharesdk/framework/statistics/b/a;->c:I
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     iget v2, p0, Lcn/sharesdk/framework/statistics/b/a;->a:I
a=0;// 
a=0;//     #v2=(Integer);
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     iget-object v2, p0, Lcn/sharesdk/framework/statistics/b/a;->b:Ljava/lang/String;
a=0;// 
