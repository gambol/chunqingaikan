package net.slidingmenu.tools.os.d.b; class k { void a() { int a;
a=0;// .class public Lnet/slidingmenu/tools/os/d/b/k;
a=0;// .super Ljava/lang/Object;
a=0;// 
a=0;// 
a=0;// # direct methods
a=0;// .method private static a(Landroid/content/Context;Ljava/lang/String;)J
a=0;//     .locals 5
a=0;// 
...
a=0;//     invoke-static {}, Lnet/slidingmenu/tools/os/b/a;->e()Ljava/lang/String;
a=0;// 
...
a=0;//     invoke-interface {v2, p1, v3, v4}, Landroid/content/SharedPreferences;->getLong(Ljava/lang/String;J)J
a=0;//     :try_end_0
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {}, Lnet/slidingmenu/tools/os/b/a;->f()Ljava/lang/String;
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method static b(Landroid/content/Context;)V
a=0;//     .locals 4
a=0;// 
a=0;//     :try_start_0
a=0;//     invoke-static {}, Lnet/slidingmenu/tools/os/b/a;->e()Ljava/lang/String;
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {}, Lnet/slidingmenu/tools/os/b/a;->g()Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v1
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;// .end method
a=0;// 
a=0;// .method static d(Landroid/content/Context;)Z
a=0;//     .locals 5
a=0;// 
a=0;//     const/4 v0, 0x0
a=0;// 
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     invoke-static {p0, v1}, Lnet/slidingmenu/tools/os/d/b/k;->a(Landroid/content/Context;Ljava/lang/String;)J
a=0;// 
