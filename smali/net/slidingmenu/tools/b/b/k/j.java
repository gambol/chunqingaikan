package net.slidingmenu.tools.b.b.k; class j { void a() { int a;
a=0;// .class public Lnet/slidingmenu/tools/b/b/k/j;
...
a=0;// .end method
a=0;// 
a=0;// .method public static b(Landroid/content/Context;Ljava/lang/String;)Lnet/slidingmenu/tools/b/b/k/a;
a=0;//     .locals 9
a=0;// 
a=0;//     const/4 v1, 0x0
a=0;// 
...
a=0;// 
a=0;//     :goto_0
a=0;//     #v0=(Reference,Lnet/slidingmenu/tools/b/b/k/a;);v2=(Conflicted);v3=(Conflicted);v4=(Conflicted);v5=(Conflicted);v6=(Conflicted);v7=(Conflicted);v8=(Conflicted);
a=0;//     return-object v0
a=0;// 
a=0;//     :cond_0
a=0;//     :try_start_0
...
a=0;// 
a=0;//     #v2=(One);
a=0;//     invoke-virtual {v3, v0, v2}, Landroid/content/pm/PackageManager;->queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
a=0;// 
...
a=0;// 
a=0;//     :goto_1
a=0;//     #v0=(Integer);v2=(Integer);v5=(Conflicted);v6=(Conflicted);v7=(Conflicted);v8=(Conflicted);
...
a=0;// 
a=0;//     :cond_2
a=0;//     #v0=(Reference,Landroid/content/pm/ResolveInfo;);v5=(Boolean);
a=0;//     invoke-virtual {v0, v3}, Landroid/content/pm/ResolveInfo;->loadLabel(Landroid/content/pm/PackageManager;)Ljava/lang/CharSequence;
a=0;// 
...
a=0;//     iget-object v6, v6, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
a=0;// 
a=0;//     iget v6, v6, Landroid/content/pm/ApplicationInfo;->icon:I
a=0;// 
a=0;//     #v6=(Integer);
a=0;//     iget-object v0, v0, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;
a=0;// 
a=0;//     iget-object v7, v0, Landroid/content/pm/ActivityInfo;->name:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     new-instance v0, Lnet/slidingmenu/tools/b/b/k/a;
a=0;// 
a=0;//     #v0=(UninitRef,Lnet/slidingmenu/tools/b/b/k/a;);
a=0;//     invoke-direct {v0, v5, v6, v7}, Lnet/slidingmenu/tools/b/b/k/a;-><init>(Ljava/lang/String;ILjava/lang/String;)V
a=0;//     :try_end_1
a=0;//     .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
a=0;// 
a=0;//     #v0=(Reference,Lnet/slidingmenu/tools/b/b/k/a;);
a=0;//     goto :goto_0
a=0;// 
a=0;//     :catch_0
...
a=0;// .end method
a=0;// 
a=0;// .method public static c(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
a=0;//     .locals 3
a=0;// 
a=0;//     const/4 v0, 0x0
a=0;// 
...
a=0;//     :cond_0
a=0;//     :goto_0
a=0;//     #v0=(Reference,Landroid/content/pm/PackageInfo;);v1=(Conflicted);v2=(Conflicted);
a=0;//     return-object v0
a=0;// 
a=0;//     :cond_1
a=0;//     :try_start_0
...
a=0;// .end method
a=0;// 
a=0;// .method public static d(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
a=0;//     .locals 4
a=0;// 
a=0;//     const/4 v0, 0x0
a=0;// 
...
a=0;//     :cond_0
a=0;//     :goto_0
a=0;//     #v0=(Reference,Landroid/content/Intent;);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);
a=0;//     return-object v0
a=0;// 
a=0;//     :cond_1
a=0;//     :try_start_0
...
a=0;//     invoke-direct {v1, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method public static e(Landroid/content/Context;Ljava/lang/String;)V
a=0;//     .locals 1
a=0;// 
a=0;//     if-nez p1, :cond_1
a=0;// 
...
a=0;//     :try_start_0
a=0;//     #v0=(Uninit);
a=0;//     invoke-static {p0, p1}, Lnet/slidingmenu/tools/b/b/k/j;->d(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,Landroid/content/Intent;);
