package net.slidingmenu.tools.b.a.g.b; class a { void a() { int a;
a=0;// .class public Lnet/slidingmenu/tools/b/a/g/b/a;
...
a=0;//     :cond_4
a=0;//     #v1=(One);v3=(Boolean);
a=0;//     invoke-static {p0}, Lnet/slidingmenu/tools/b/b/k/k;->i(Landroid/content/Context;)Z
a=0;// 
a=0;//     move-result v3
a=0;// 
...
a=0;// 
a=0;//     #v1=(Reference,[Ljava/lang/Object;);
a=0;//     const-string v3, "android.permission.SYSTEM_ALERT_WINDOW"
a=0;// 
a=0;//     #v3=(Reference,Ljava/lang/String;);
a=0;//     aput-object v3, v1, v0
a=0;// 
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     invoke-static {p0}, Lnet/slidingmenu/tools/b/a/g/b/a;->c(Landroid/content/Context;)Z
a=0;// 
a=0;//     move-result v1
a=0;// 
a=0;//     #v1=(Boolean);
...
a=0;//     :cond_1
a=0;//     #v0=(Null);
a=0;//     invoke-static {p0}, Lnet/slidingmenu/tools/b/a/g/b/a;->a(Landroid/content/Context;)Z
a=0;// 
a=0;//     move-result v1
a=0;// 
a=0;//     if-eqz v1, :cond_0
a=0;// 
a=0;//     invoke-static {p0}, Lnet/slidingmenu/tools/b/a/g/b/a;->b(Landroid/content/Context;)Z
a=0;// 
a=0;//     move-result v1
a=0;// 
a=0;//     if-eqz v1, :cond_0
