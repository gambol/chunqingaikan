package net.slidingmenu.tools.b.a.g.a; class a { void a() { int a;
a=0;// .class public Lnet/slidingmenu/tools/b/a/g/a/a;
...
a=0;//     :try_start_0
a=0;//     #v0=(Null);
a=0;//     new-instance v1, Landroid/text/format/Time;
a=0;// 
a=0;//     #v1=(UninitRef,Landroid/text/format/Time;);
a=0;//     invoke-direct {v1}, Landroid/text/format/Time;-><init>()V
a=0;// 
a=0;//     #v1=(Reference,Landroid/text/format/Time;);
a=0;//     invoke-virtual {v1}, Landroid/text/format/Time;->setToNow()V
a=0;// 
a=0;//     const-string v2, "%Y-%m-%d"
a=0;// 
a=0;//     #v2=(Reference,Ljava/lang/String;);
a=0;//     invoke-virtual {v1, v2}, Landroid/text/format/Time;->format(Ljava/lang/String;)Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     #v2=(Null);
a=0;//     invoke-static {p0, v1, v2}, Lnet/slidingmenu/tools/b/b/c/f;->a(Landroid/content/Context;Ljava/lang/String;Z)Z
a=0;//     :try_end_0
...
a=0;// 
a=0;//     #v1=(One);
a=0;//     const-wide/32 v2, 0x5265c00
a=0;// 
a=0;//     #v2=(LongLo);v3=(LongHi);
a=0;//     invoke-static {p0, v0, v1, v2, v3}, Lnet/slidingmenu/tools/b/b/c/f;->a(Landroid/content/Context;Ljava/lang/String;ZJ)Z
a=0;//     :try_end_0
a=0;//     .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
a=0;// 
a=0;//     move-result v0
