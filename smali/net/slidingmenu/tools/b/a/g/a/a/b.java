package net.slidingmenu.tools.b.a.g.a.a; class b { void a() { int a;
a=0;// .class Lnet/slidingmenu/tools/b/a/g/a/a/b;
...
a=0;//     .locals 3
a=0;// 
a=0;//     invoke-static {p1}, Lnet/slidingmenu/tools/b/a/g/a/a/b;->a(Landroid/content/Context;)Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,Lnet/slidingmenu/tools/b/a/g/a/a/b;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .locals 1
a=0;// 
a=0;//     const-string v0, "CREATE TABLE IF NOT EXISTS b5I3kl9i(a VARCHAR PRIMARY KEY, b VARCHAR, c INTEGER, d INTEGER, e INTEGER, f VARCHAR, g VARCHAR);"
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
...
a=0;//     .locals 1
a=0;// 
a=0;//     const-string v0, "DROP TABLE IF EXISTS b5I3kl9i"
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lnet/slidingmenu/tools/b/a/g/a/a/b;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
a=0;// 
a=0;//     return-void
a=0;// .end method
}}
