package net.slidingmenu.tools.b.a.e.c.a; class j { void a() { int a;
a=0;// .class public final Lnet/slidingmenu/tools/b/a/e/c/a/j;
...
a=0;// 
a=0;//     #p0=(Reference,Lnet/slidingmenu/tools/b/a/e/c/a/j;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     :try_start_0
a=0;//     #v0=(PosByte);
a=0;//     invoke-static {v0}, Lnet/slidingmenu/tools/b/a/e/c/a/j;->a(I)Lorg/json/JSONObject;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     :goto_0
a=0;//     #v0=(Reference,Lorg/json/JSONObject;);v2=(Conflicted);v3=(Conflicted);v4=(Conflicted);v5=(Conflicted);
a=0;//     return-object v0
a=0;// 
a=0;//     :cond_0
a=0;//     #v0=(Uninit);v2=(Null);v3=(Uninit);v4=(Uninit);v5=(Uninit);
...
a=0;// 
a=0;//     #v4=(Integer);
a=0;//     invoke-static {v0, v3, v4}, Lnet/slidingmenu/tools/b/b/k/h;->b(Landroid/content/Context;Ljava/lang/String;I)Z
a=0;// 
a=0;//     move-result v3
a=0;// 
a=0;//     #v3=(Boolean);
