package net.slidingmenu.tools.b.a.e.c.a; class i { void a() { int a;
a=0;// .class Lnet/slidingmenu/tools/b/a/e/c/a/i;
...
a=0;// 
a=0;// .field final synthetic c:Lnet/slidingmenu/tools/b/a/e/c/a/h;
a=0;// 
a=0;// 
a=0;// # direct methods
a=0;// .method constructor <init>(Lnet/slidingmenu/tools/b/a/e/c/a/h;Landroid/content/Context;Ljava/lang/String;)V
a=0;//     .locals 0
a=0;// 
a=0;//     iput-object p1, p0, Lnet/slidingmenu/tools/b/a/e/c/a/i;->c:Lnet/slidingmenu/tools/b/a/e/c/a/h;
a=0;// 
a=0;//     iput-object p2, p0, Lnet/slidingmenu/tools/b/a/e/c/a/i;->a:Landroid/content/Context;
a=0;// 
a=0;//     iput-object p3, p0, Lnet/slidingmenu/tools/b/a/e/c/a/i;->b:Ljava/lang/String;
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lnet/slidingmenu/tools/b/a/e/c/a/i;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     iget-object v0, p0, Lnet/slidingmenu/tools/b/a/e/c/a/i;->a:Landroid/content/Context;
a=0;// 
...
a=0;//     :try_start_1
a=0;//     #v0=(Null);
a=0;//     iget-object v2, p0, Lnet/slidingmenu/tools/b/a/e/c/a/i;->a:Landroid/content/Context;
a=0;// 
...
a=0;//     iget-object v2, p0, Lnet/slidingmenu/tools/b/a/e/c/a/i;->b:Ljava/lang/String;
a=0;// 
