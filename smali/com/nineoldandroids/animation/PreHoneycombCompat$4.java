package com.nineoldandroids.animation; class PreHoneycombCompat$4 { void a() { int a;
a=0;// .class Lcom/nineoldandroids/animation/PreHoneycombCompat$4;
...
a=0;// 
a=0;//     .line 1
a=0;//     #p0=(Reference,Lcom/nineoldandroids/animation/PreHoneycombCompat$4;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lcom/nineoldandroids/animation/PreHoneycombCompat$4;->get(Landroid/view/View;)Ljava/lang/Float;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/Float;);
...
a=0;//     check-cast p1, Landroid/view/View;
a=0;// 
a=0;//     invoke-virtual {p0, p1, p2}, Lcom/nineoldandroids/animation/PreHoneycombCompat$4;->setValue(Landroid/view/View;F)V
a=0;// 
a=0;//     return-void
a=0;// .end method
}}
