package com.nineoldandroids.animation; class FloatEvaluator { void a() { int a;
a=0;// .class public Lcom/nineoldandroids/animation/FloatEvaluator;
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/nineoldandroids/animation/FloatEvaluator;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {p0, p1, p2, p3}, Lcom/nineoldandroids/animation/FloatEvaluator;->evaluate(FLjava/lang/Number;Ljava/lang/Number;)Ljava/lang/Float;
a=0;// 
