package com.nineoldandroids.animation; class IntEvaluator { void a() { int a;
a=0;// .class public Lcom/nineoldandroids/animation/IntEvaluator;
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/nineoldandroids/animation/IntEvaluator;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {p0, p1, p2, p3}, Lcom/nineoldandroids/animation/IntEvaluator;->evaluate(FLjava/lang/Integer;Ljava/lang/Integer;)Ljava/lang/Integer;
a=0;// 
