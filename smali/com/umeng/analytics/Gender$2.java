package com.umeng.analytics; class Gender$2 { void a() { int a;
a=0;// .class enum Lcom/umeng/analytics/Gender$2;
...
a=0;// 
a=0;//     .line 1
a=0;//     #p0=(Reference,Lcom/umeng/analytics/Gender$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     #v3=(Null);
a=0;//     iget v4, p0, Lcom/umeng/analytics/Gender$2;->value:I
a=0;// 
a=0;//     #v4=(Integer);
