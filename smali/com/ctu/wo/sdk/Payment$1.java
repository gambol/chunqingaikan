package com.ctu.wo.sdk; class Payment$1 { void a() { int a;
a=0;// .class Lcom/ctu/wo/sdk/Payment$1;
...
a=0;//     value = Lcom/ctu/wo/sdk/Payment;->ShowError(Ljava/lang/String;Ljava/lang/String;)V
a=0;// .end annotation
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 183
a=0;//     iput-object p1, p0, Lcom/ctu/wo/sdk/Payment$1;->this$0:Lcom/ctu/wo/sdk/Payment;
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/ctu/wo/sdk/Payment$1;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
