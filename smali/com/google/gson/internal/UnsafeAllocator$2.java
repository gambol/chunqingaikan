package com.google.gson.internal; class UnsafeAllocator$2 { void a() { int a;
a=0;// .class final Lcom/google/gson/internal/UnsafeAllocator$2;
...
a=0;// 
a=0;// # direct methods
a=0;// .method constructor <init>(Ljava/lang/reflect/Method;)V
a=0;//     .locals 0
a=0;// 
a=0;//     .prologue
a=0;//     .line 63
a=0;//     iput-object p1, p0, Lcom/google/gson/internal/UnsafeAllocator$2;->val$newInstance:Ljava/lang/reflect/Method;
a=0;// 
a=0;//     invoke-direct {p0}, Lcom/google/gson/internal/UnsafeAllocator;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/google/gson/internal/UnsafeAllocator$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     iget-object v0, p0, Lcom/google/gson/internal/UnsafeAllocator$2;->val$newInstance:Ljava/lang/reflect/Method;
a=0;// 
