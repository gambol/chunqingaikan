package com.google.gson.internal.bind; class TypeAdapters$5 { void a() { int a;
a=0;// .class final Lcom/google/gson/internal/bind/TypeAdapters$5;
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/google/gson/internal/bind/TypeAdapters$5;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     .line 195
a=0;//     .local v1, "intValue":I
a=0;//     #v1=(Integer);
a=0;//     int-to-byte v2, v1
a=0;// 
a=0;//     #v2=(Byte);
a=0;//     invoke-static {v2}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;
a=0;//     :try_end_0
a=0;//     .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_0} :catch_0
a=0;// 
a=0;//     move-result-object v2
a=0;// 
a=0;//     #v2=(Reference,Ljava/lang/Byte;);
a=0;//     goto :goto_0
a=0;// 
a=0;//     .line 196
a=0;//     .end local v1    # "intValue":I
a=0;//     :catch_0
...
a=0;//     .prologue
a=0;//     .line 186
a=0;//     invoke-virtual {p0, p1}, Lcom/google/gson/internal/bind/TypeAdapters$5;->read(Lcom/google/gson/stream/JsonReader;)Ljava/lang/Number;
a=0;// 
...
a=0;//     invoke-virtual {p0, p1, p2}, Lcom/google/gson/internal/bind/TypeAdapters$5;->write(Lcom/google/gson/stream/JsonWriter;Ljava/lang/Number;)V
a=0;// 
a=0;//     return-void
a=0;// .end method
}}
