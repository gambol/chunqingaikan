package com.google.gson.internal.bind; class ObjectTypeAdapter$2 { void a() { int a;
a=0;// .class synthetic Lcom/google/gson/internal/bind/ObjectTypeAdapter$2;
...
a=0;// 
a=0;// # static fields
a=0;// .field static final synthetic $SwitchMap$com$google$gson$stream$JsonToken:[I
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .prologue
a=0;//     .line 56
a=0;//     invoke-static {}, Lcom/google/gson/stream/JsonToken;->values()[Lcom/google/gson/stream/JsonToken;
a=0;// 
...
a=0;// 
a=0;//     #v0=(Reference,[I);
a=0;//     sput-object v0, Lcom/google/gson/internal/bind/ObjectTypeAdapter$2;->$SwitchMap$com$google$gson$stream$JsonToken:[I
a=0;// 
a=0;//     :try_start_0
a=0;//     sget-object v0, Lcom/google/gson/internal/bind/ObjectTypeAdapter$2;->$SwitchMap$com$google$gson$stream$JsonToken:[I
a=0;// 
...
a=0;//     invoke-virtual {v1}, Lcom/google/gson/stream/JsonToken;->ordinal()I
a=0;// 
a=0;//     move-result v1
a=0;// 
a=0;//     #v1=(Integer);
