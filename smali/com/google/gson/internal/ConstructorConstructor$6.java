package com.google.gson.internal; class ConstructorConstructor$6 { void a() { int a;
a=0;// .class Lcom/google/gson/internal/ConstructorConstructor$6;
...
a=0;// 
a=0;// # direct methods
a=0;// .method constructor <init>(Lcom/google/gson/internal/ConstructorConstructor;)V
a=0;//     .locals 0
a=0;// 
a=0;//     .prologue
a=0;//     .line 154
a=0;//     iput-object p1, p0, Lcom/google/gson/internal/ConstructorConstructor$6;->this$0:Lcom/google/gson/internal/ConstructorConstructor;
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/google/gson/internal/ConstructorConstructor$6;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 156
a=0;//     new-instance v0, Ljava/util/LinkedHashSet;
a=0;// 
a=0;//     #v0=(UninitRef,Ljava/util/LinkedHashSet;);
a=0;//     invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V
a=0;// 
