package com.google.gson; class FieldNamingPolicy$3 { void a() { int a;
a=0;// .class final enum Lcom/google/gson/FieldNamingPolicy$3;
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/google/gson/FieldNamingPolicy$3;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {v0}, Lcom/google/gson/FieldNamingPolicy;->access$100(Ljava/lang/String;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
