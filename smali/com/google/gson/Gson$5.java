package com.google.gson; class Gson$5 { void a() { int a;
a=0;// .class Lcom/google/gson/Gson$5;
...
a=0;//     value = Lcom/google/gson/Gson;->longAdapter(Lcom/google/gson/LongSerializationPolicy;)Lcom/google/gson/TypeAdapter;
a=0;// .end annotation
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 306
a=0;//     iput-object p1, p0, Lcom/google/gson/Gson$5;->this$0:Lcom/google/gson/Gson;
a=0;// 
a=0;//     invoke-direct {p0}, Lcom/google/gson/TypeAdapter;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/google/gson/Gson$5;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 306
a=0;//     invoke-virtual {p0, p1}, Lcom/google/gson/Gson$5;->read(Lcom/google/gson/stream/JsonReader;)Ljava/lang/Number;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
...
a=0;//     invoke-virtual {p0, p1, p2}, Lcom/google/gson/Gson$5;->write(Lcom/google/gson/stream/JsonWriter;Ljava/lang/Number;)V
a=0;// 
a=0;//     return-void
a=0;// .end method
}}
