package com.actionbarsherlock.widget; class ActivityChooserModel$ActivityResolveInfo { void a() { int a;
a=0;// .class public final Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;
...
a=0;// 
a=0;// # direct methods
a=0;// .method public constructor <init>(Lcom/actionbarsherlock/widget/ActivityChooserModel;Landroid/content/pm/ResolveInfo;)V
a=0;//     .locals 0
a=0;//     .param p2, "resolveInfo"    # Landroid/content/pm/ResolveInfo;
a=0;// 
a=0;//     .prologue
a=0;//     .line 840
a=0;//     iput-object p1, p0, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->this$0:Lcom/actionbarsherlock/widget/ActivityChooserModel;
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     .line 841
a=0;//     #p0=(Reference,Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;);
a=0;//     iput-object p2, p0, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->resolveInfo:Landroid/content/pm/ResolveInfo;
a=0;// 
a=0;//     .line 842
a=0;//     return-void
a=0;// .end method
...
a=0;// 
a=0;// # virtual methods
a=0;// .method public compareTo(Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;)I
a=0;//     .locals 2
a=0;//     .param p1, "another"    # Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;
a=0;// 
a=0;//     .prologue
a=0;//     .line 868
a=0;//     iget v0, p1, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->weight:F
a=0;// 
a=0;//     #v0=(Integer);
...
a=0;//     move-result v0
a=0;// 
a=0;//     iget v1, p0, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->weight:F
a=0;// 
a=0;//     #v1=(Integer);
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     check-cast p1, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->compareTo(Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;)I
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Integer);
...
a=0;// 
a=0;//     .line 861
a=0;//     .local v0, "other":Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;
a=0;//     iget v3, p0, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->weight:F
a=0;// 
a=0;//     #v3=(Integer);
...
a=0;//     move-result v3
a=0;// 
a=0;//     iget v4, v0, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->weight:F
a=0;// 
a=0;//     #v4=(Integer);
...
a=0;//     .prologue
a=0;//     .line 846
a=0;//     iget v0, p0, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->weight:F
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     invoke-static {v0}, Ljava/lang/Float;->floatToIntBits(F)I
a=0;// 
...
a=0;// 
a=0;//     iget-object v2, p0, Lcom/actionbarsherlock/widget/ActivityChooserModel$ActivityResolveInfo;->resolveInfo:Landroid/content/pm/ResolveInfo;
a=0;// 
