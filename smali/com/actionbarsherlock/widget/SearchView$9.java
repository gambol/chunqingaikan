package com.actionbarsherlock.widget; class SearchView$9 { void a() { int a;
a=0;// .class Lcom/actionbarsherlock/widget/SearchView$9;
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/actionbarsherlock/widget/SearchView$9;->this$0:Lcom/actionbarsherlock/widget/SearchView;
a=0;// 
a=0;//     .line 1645
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/actionbarsherlock/widget/SearchView$9;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 1651
a=0;//     iget-object v0, p0, Lcom/actionbarsherlock/widget/SearchView$9;->this$0:Lcom/actionbarsherlock/widget/SearchView;
a=0;// 
a=0;//     #v0=(Reference,Lcom/actionbarsherlock/widget/SearchView;);
a=0;//     invoke-static {v0, p1}, Lcom/actionbarsherlock/widget/SearchView;->access$18(Lcom/actionbarsherlock/widget/SearchView;Ljava/lang/CharSequence;)V
a=0;// 
a=0;//     .line 1652
a=0;//     return-void
a=0;// .end method
