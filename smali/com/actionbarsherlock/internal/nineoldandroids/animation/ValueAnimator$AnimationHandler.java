package com.actionbarsherlock.internal.nineoldandroids.animation; class ValueAnimator$AnimationHandler { void a() { int a;
a=0;// .class Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator$AnimationHandler;
...
a=0;//     value = Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;
a=0;// .end annotation
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator$AnimationHandler;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// .method synthetic constructor <init>(Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator$AnimationHandler;)V
a=0;//     .locals 0
a=0;// 
a=0;//     .prologue
a=0;//     .line 571
a=0;//     invoke-direct {p0}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator$AnimationHandler;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator$AnimationHandler;);
a=0;//     return-void
a=0;// .end method
...
a=0;//     #v6=(One);
a=0;//     invoke-static {}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$2()Ljava/lang/ThreadLocal;
a=0;// 
...
a=0;// 
a=0;//     .line 588
a=0;//     .local v5, "animations":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     invoke-static {}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$3()Ljava/lang/ThreadLocal;
a=0;// 
a=0;//     move-result-object v19
a=0;// 
a=0;//     invoke-virtual/range {v19 .. v19}, Ljava/lang/ThreadLocal;->get()Ljava/lang/Object;
...
a=0;// 
a=0;//     .line 589
a=0;//     .local v10, "delayedAnims":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
...
a=0;//     invoke-static {}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$4()Ljava/lang/ThreadLocal;
a=0;// 
a=0;//     move-result-object v19
a=0;// 
a=0;//     #v19=(Reference,Ljava/lang/ThreadLocal;);
...
a=0;// 
a=0;//     .line 594
a=0;//     .local v16, "pendingAnimations":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
...
a=0;// 
a=0;//     .line 621
a=0;//     .end local v16    # "pendingAnimations":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     :pswitch_1
a=0;//     #v16=(Conflicted);
...
a=0;//     invoke-static {}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$7()Ljava/lang/ThreadLocal;
a=0;// 
a=0;//     move-result-object v19
a=0;// 
a=0;//     #v19=(Reference,Ljava/lang/ThreadLocal;);
...
a=0;// 
a=0;//     .line 623
a=0;//     .local v18, "readyAnims":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     invoke-static {}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$8()Ljava/lang/ThreadLocal;
a=0;// 
a=0;//     move-result-object v19
a=0;// 
a=0;//     invoke-virtual/range {v19 .. v19}, Ljava/lang/ThreadLocal;->get()Ljava/lang/Object;
...
a=0;// 
a=0;//     .line 627
a=0;//     .local v11, "endingAnims":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     invoke-virtual {v10}, Ljava/util/ArrayList;->size()I
a=0;// 
a=0;//     move-result v14
a=0;// 
...
a=0;//     invoke-static {}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$12()J
a=0;// 
...
a=0;//     invoke-virtual {v0, v1, v2, v3}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator$AnimationHandler;->sendEmptyMessageDelayed(IJ)Z
a=0;// 
a=0;//     goto/16 :goto_0
a=0;// 
a=0;//     .line 604
a=0;//     .end local v8    # "currentTime":J
a=0;//     .end local v11    # "endingAnims":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     .end local v12    # "i":I
a=0;//     .end local v13    # "numAnims":I
a=0;//     .end local v14    # "numDelayedAnims":I
a=0;//     .end local v15    # "numReadyAnims":I
a=0;//     .end local v18    # "readyAnims":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     .restart local v16    # "pendingAnimations":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     :cond_6
...
a=0;// 
a=0;//     .line 605
a=0;//     .local v17, "pendingCopy":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
...
a=0;//     check-cast v4, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;
a=0;// 
a=0;//     .line 610
a=0;//     .local v4, "anim":Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;
a=0;//     invoke-static {v4}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$5(Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;)J
a=0;// 
...
a=0;// 
a=0;//     .line 611
a=0;//     invoke-static {v4}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$6(Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;)V
a=0;// 
a=0;//     .line 607
a=0;//     :goto_6
...
a=0;// 
a=0;//     .line 629
a=0;//     .end local v4    # "anim":Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;
a=0;//     .end local v7    # "count":I
a=0;//     .end local v16    # "pendingAnimations":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     .end local v17    # "pendingCopy":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     .restart local v8    # "currentTime":J
a=0;//     .restart local v11    # "endingAnims":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     .restart local v14    # "numDelayedAnims":I
a=0;//     .restart local v18    # "readyAnims":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;>;"
a=0;//     :cond_8
...
a=0;// 
a=0;//     .line 630
a=0;//     .restart local v4    # "anim":Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;
a=0;//     invoke-static {v4, v8, v9}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$9(Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;J)Z
a=0;// 
a=0;//     move-result v19
a=0;// 
a=0;//     #v19=(Boolean);
...
a=0;// 
a=0;//     #v0=(One);
a=0;//     invoke-static {v4, v0}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$10(Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;Z)V
a=0;// 
a=0;//     .line 640
...
a=0;//     .line 651
a=0;//     .restart local v4    # "anim":Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;
a=0;//     invoke-virtual {v4, v8, v9}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->animationFrame(J)Z
a=0;// 
a=0;//     move-result v19
a=0;// 
a=0;//     #v19=(Boolean);
...
a=0;//     check-cast v19, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;
a=0;// 
a=0;//     invoke-static/range {v19 .. v19}, Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;->access$11(Lcom/actionbarsherlock/internal/nineoldandroids/animation/ValueAnimator;)V
a=0;// 
a=0;//     .line 669
a=0;//     add-int/lit8 v12, v12, 0x1
a=0;// 
