package com.actionbarsherlock.internal.nineoldandroids.widget; class NineLinearLayout { void a() { int a;
a=0;// .class public Lcom/actionbarsherlock/internal/nineoldandroids/widget/NineLinearLayout;
a=0;// .super Landroid/widget/LinearLayout;
a=0;// .source "NineLinearLayout.java"
a=0;// 
a=0;// 
a=0;// # instance fields
...
a=0;// 
a=0;//     .line 14
a=0;//     #p0=(Reference,Lcom/actionbarsherlock/internal/nineoldandroids/widget/NineLinearLayout;);
...
a=0;//     iput-object v0, p0, Lcom/actionbarsherlock/internal/nineoldandroids/widget/NineLinearLayout;->mProxy:Lcom/actionbarsherlock/internal/nineoldandroids/view/animation/AnimatorProxy;
a=0;// 
a=0;//     .line 15
a=0;//     return-void
a=0;// 
...
a=0;// 
a=0;//     .line 31
a=0;//     iget-object v0, p0, Lcom/actionbarsherlock/internal/nineoldandroids/widget/NineLinearLayout;->mProxy:Lcom/actionbarsherlock/internal/nineoldandroids/view/animation/AnimatorProxy;
a=0;// 
a=0;//     #v0=(Reference,Lcom/actionbarsherlock/internal/nineoldandroids/view/animation/AnimatorProxy;);
...
a=0;//     :cond_0
a=0;//     #v0=(Boolean);
a=0;//     invoke-super {p0}, Landroid/widget/LinearLayout;->getAlpha()F
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Float);
...
a=0;//     :cond_0
a=0;//     #v0=(Boolean);
a=0;//     invoke-super {p0}, Landroid/widget/LinearLayout;->getTranslationX()F
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Float);
...
a=0;//     :cond_0
a=0;//     #v0=(Boolean);
a=0;//     invoke-super {p0, p1}, Landroid/widget/LinearLayout;->setAlpha(F)V
a=0;// 
a=0;//     goto :goto_0
a=0;// .end method
a=0;// 
...
a=0;//     :cond_0
a=0;//     #v0=(Boolean);
a=0;//     invoke-super {p0, p1}, Landroid/widget/LinearLayout;->setTranslationX(F)V
a=0;// 
a=0;//     goto :goto_0
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     .line 21
a=0;//     invoke-virtual {p0}, Lcom/actionbarsherlock/internal/nineoldandroids/widget/NineLinearLayout;->clearAnimation()V
a=0;// 
a=0;//     .line 26
a=0;//     :cond_0
a=0;//     :goto_0
a=0;//     #v0=(Conflicted);
a=0;//     invoke-super {p0, p1}, Landroid/widget/LinearLayout;->setVisibility(I)V
a=0;// 
a=0;//     .line 27
a=0;//     return-void
a=0;// 
...
a=0;// 
a=0;//     #v0=(Reference,Lcom/actionbarsherlock/internal/nineoldandroids/view/animation/AnimatorProxy;);
a=0;//     invoke-virtual {p0, v0}, Lcom/actionbarsherlock/internal/nineoldandroids/widget/NineLinearLayout;->setAnimation(Landroid/view/animation/Animation;)V
a=0;// 
a=0;//     goto :goto_0
a=0;// .end method
}}
