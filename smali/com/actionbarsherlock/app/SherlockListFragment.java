package com.actionbarsherlock.app; class SherlockListFragment { void a() { int a;
a=0;// .class public Lcom/actionbarsherlock/app/SherlockListFragment;
a=0;// .super Landroid/support/v4/app/ListFragment;
a=0;// .source "SherlockListFragment.java"
a=0;// 
a=0;// # interfaces
...
a=0;//     .prologue
a=0;//     .line 15
a=0;//     invoke-direct {p0}, Landroid/support/v4/app/ListFragment;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/actionbarsherlock/app/SherlockListFragment;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 19
a=0;//     iget-object v0, p0, Lcom/actionbarsherlock/app/SherlockListFragment;->mActivity:Lcom/actionbarsherlock/app/SherlockFragmentActivity;
a=0;// 
...
a=0;// 
a=0;//     iput-object v0, p0, Lcom/actionbarsherlock/app/SherlockListFragment;->mActivity:Lcom/actionbarsherlock/app/SherlockFragmentActivity;
a=0;// 
a=0;//     .line 29
a=0;//     invoke-super {p0, p1}, Landroid/support/v4/app/ListFragment;->onAttach(Landroid/app/Activity;)V
a=0;// 
a=0;//     .line 30
a=0;//     return-void
a=0;// .end method
...
a=0;//     iget-object v1, p0, Lcom/actionbarsherlock/app/SherlockListFragment;->mActivity:Lcom/actionbarsherlock/app/SherlockFragmentActivity;
a=0;// 
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     invoke-virtual {p0, v0, v1}, Lcom/actionbarsherlock/app/SherlockListFragment;->onCreateOptionsMenu(Lcom/actionbarsherlock/view/Menu;Lcom/actionbarsherlock/view/MenuInflater;)V
a=0;// 
a=0;//     .line 41
a=0;//     return-void
a=0;// .end method
...
a=0;// 
a=0;//     .line 35
a=0;//     invoke-super {p0}, Landroid/support/v4/app/ListFragment;->onDetach()V
a=0;// 
a=0;//     .line 36
a=0;//     return-void
a=0;// .end method
...
a=0;//     invoke-virtual {p0, v0}, Lcom/actionbarsherlock/app/SherlockListFragment;->onOptionsItemSelected(Lcom/actionbarsherlock/view/MenuItem;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;// 
a=0;//     #v0=(Reference,Lcom/actionbarsherlock/internal/view/menu/MenuWrapper;);
a=0;//     invoke-virtual {p0, v0}, Lcom/actionbarsherlock/app/SherlockListFragment;->onPrepareOptionsMenu(Lcom/actionbarsherlock/view/Menu;)V
a=0;// 
a=0;//     .line 51
a=0;//     return-void
a=0;// .end method
