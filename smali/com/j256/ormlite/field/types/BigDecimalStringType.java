package com.j256.ormlite.field.types; class BigDecimalStringType { void a() { int a;
a=0;// .class public Lcom/j256/ormlite/field/types/BigDecimalStringType;
a=0;// .super Lcom/j256/ormlite/field/types/BaseDataType;
a=0;// .source "BigDecimalStringType.java"
a=0;// 
a=0;// 
a=0;// # static fields
a=0;// .field public static DEFAULT_WIDTH:I
a=0;// 
a=0;// .field private static final singleTon:Lcom/j256/ormlite/field/types/BigDecimalStringType;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;// 
a=0;//     #v0=(PosShort);
a=0;//     sput v0, Lcom/j256/ormlite/field/types/BigDecimalStringType;->DEFAULT_WIDTH:I
a=0;// 
a=0;//     .line 21
a=0;//     new-instance v0, Lcom/j256/ormlite/field/types/BigDecimalStringType;
a=0;// 
a=0;//     #v0=(UninitRef,Lcom/j256/ormlite/field/types/BigDecimalStringType;);
a=0;//     invoke-direct {v0}, Lcom/j256/ormlite/field/types/BigDecimalStringType;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Lcom/j256/ormlite/field/types/BigDecimalStringType;);
a=0;//     sput-object v0, Lcom/j256/ormlite/field/types/BigDecimalStringType;->singleTon:Lcom/j256/ormlite/field/types/BigDecimalStringType;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #v2=(Null);
a=0;//     const-class v3, Ljava/math/BigDecimal;
a=0;// 
...
a=0;// 
a=0;//     .line 29
a=0;//     #p0=(Reference,Lcom/j256/ormlite/field/types/BigDecimalStringType;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method public static getSingleton()Lcom/j256/ormlite/field/types/BigDecimalStringType;
a=0;//     .locals 1
a=0;// 
a=0;//     .prologue
a=0;//     .line 24
a=0;//     sget-object v0, Lcom/j256/ormlite/field/types/BigDecimalStringType;->singleTon:Lcom/j256/ormlite/field/types/BigDecimalStringType;
a=0;// 
a=0;//     #v0=(Reference,Lcom/j256/ormlite/field/types/BigDecimalStringType;);
...
a=0;//     .prologue
a=0;//     .line 71
a=0;//     sget v0, Lcom/j256/ormlite/field/types/BigDecimalStringType;->DEFAULT_WIDTH:I
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     return v0
a=0;// .end method
...
a=0;// 
a=0;//     .line 66
a=0;//     .local v0, "bigInteger":Ljava/math/BigDecimal;
a=0;//     invoke-virtual {v0}, Ljava/math/BigDecimal;->toString()Ljava/lang/String;
a=0;// 
...
a=0;//     .line 56
a=0;//     :try_start_0
a=0;//     new-instance v3, Ljava/math/BigDecimal;
a=0;// 
a=0;//     #v3=(UninitRef,Ljava/math/BigDecimal;);
a=0;//     move-object v0, p2
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/Object;);
...
a=0;// 
a=0;//     #v2=(Reference,Ljava/lang/String;);
a=0;//     invoke-direct {v3, v2}, Ljava/math/BigDecimal;-><init>(Ljava/lang/String;)V
a=0;//     :try_end_0
a=0;//     .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
a=0;// 
a=0;//     #v3=(Reference,Ljava/math/BigDecimal;);
...
a=0;//     move-result-object v2
a=0;// 
a=0;//     const-string v3, " parsing BigDecimal string \'"
a=0;// 
a=0;//     invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v2
