package com.j256.ormlite.field.types; class FloatObjectType { void a() { int a;
a=0;// .class public Lcom/j256/ormlite/field/types/FloatObjectType;
a=0;// .super Lcom/j256/ormlite/field/types/BaseDataType;
a=0;// .source "FloatObjectType.java"
a=0;// 
a=0;// 
a=0;// # static fields
a=0;// .field private static final singleTon:Lcom/j256/ormlite/field/types/FloatObjectType;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .prologue
a=0;//     .line 16
a=0;//     new-instance v0, Lcom/j256/ormlite/field/types/FloatObjectType;
a=0;// 
a=0;//     #v0=(UninitRef,Lcom/j256/ormlite/field/types/FloatObjectType;);
a=0;//     invoke-direct {v0}, Lcom/j256/ormlite/field/types/FloatObjectType;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Lcom/j256/ormlite/field/types/FloatObjectType;);
a=0;//     sput-object v0, Lcom/j256/ormlite/field/types/FloatObjectType;->singleTon:Lcom/j256/ormlite/field/types/FloatObjectType;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     .line 24
a=0;//     #p0=(Reference,Lcom/j256/ormlite/field/types/FloatObjectType;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method public static getSingleton()Lcom/j256/ormlite/field/types/FloatObjectType;
a=0;//     .locals 1
a=0;// 
a=0;//     .prologue
a=0;//     .line 19
a=0;//     sget-object v0, Lcom/j256/ormlite/field/types/FloatObjectType;->singleTon:Lcom/j256/ormlite/field/types/FloatObjectType;
a=0;// 
a=0;//     #v0=(Reference,Lcom/j256/ormlite/field/types/FloatObjectType;);
...
a=0;//     .prologue
a=0;//     .line 37
a=0;//     invoke-static {p2}, Ljava/lang/Float;->parseFloat(Ljava/lang/String;)F
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Float);
...
a=0;//     .prologue
a=0;//     .line 32
a=0;//     invoke-interface {p2, p3}, Lcom/j256/ormlite/support/DatabaseResults;->getFloat(I)F
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Float);
