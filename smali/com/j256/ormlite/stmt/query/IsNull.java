package com.j256.ormlite.stmt.query; class IsNull { void a() { int a;
a=0;// .class public Lcom/j256/ormlite/stmt/query/IsNull;
a=0;// .super Lcom/j256/ormlite/stmt/query/BaseComparison;
a=0;// .source "IsNull.java"
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;// 
a=0;//     .line 20
a=0;//     #p0=(Reference,Lcom/j256/ormlite/stmt/query/IsNull;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
