package com.j256.ormlite.stmt.query; class IsNotNull { void a() { int a;
a=0;// .class public Lcom/j256/ormlite/stmt/query/IsNotNull;
a=0;// .super Lcom/j256/ormlite/stmt/query/BaseComparison;
a=0;// .source "IsNotNull.java"
a=0;// 
a=0;// 
a=0;// # direct methods
a=0;// .method public constructor <init>(Ljava/lang/String;Lcom/j256/ormlite/field/FieldType;)V
a=0;//     .locals 2
...
a=0;// 
a=0;//     .line 20
a=0;//     #p0=(Reference,Lcom/j256/ormlite/stmt/query/IsNotNull;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 24
a=0;//     const-string v0, "IS NOT NULL "
a=0;// 
