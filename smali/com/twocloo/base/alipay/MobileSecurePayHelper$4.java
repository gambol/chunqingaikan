package com.twocloo.base.alipay; class MobileSecurePayHelper$4 { void a() { int a;
a=0;// .class Lcom/twocloo/base/alipay/MobileSecurePayHelper$4;
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/base/alipay/MobileSecurePayHelper$4;->this$0:Lcom/twocloo/base/alipay/MobileSecurePayHelper;
a=0;// 
a=0;//     .line 118
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/base/alipay/MobileSecurePayHelper$4;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
