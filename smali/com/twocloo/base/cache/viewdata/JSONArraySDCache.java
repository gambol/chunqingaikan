package com.twocloo.base.cache.viewdata; class JSONArraySDCache { void a() { int a;
a=0;// .class public Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;
a=0;// .super Lcom/twocloo/base/cache/viewdata/AbsViewDataSDCache;
a=0;// .source "JSONArraySDCache.java"
a=0;// 
a=0;// 
a=0;// # annotations
...
a=0;// 
a=0;// # static fields
a=0;// .field private static volatile instance:Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;
a=0;// 
a=0;// 
a=0;// # instance fields
...
a=0;// 
a=0;//     .line 20
a=0;//     #p0=(Reference,Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;);
a=0;//     new-instance v0, Ljava/lang/StringBuilder;
a=0;// 
a=0;//     #v0=(UninitRef,Ljava/lang/StringBuilder;);
a=0;//     invoke-virtual {p0}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->getRootPath()Ljava/lang/String;
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, p0, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->rootPath:Ljava/lang/String;
a=0;// 
a=0;//     .line 23
a=0;//     invoke-virtual {p0}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->available()Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;// 
a=0;//     .line 24
a=0;//     iget-object v0, p0, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->rootPath:Ljava/lang/String;
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     invoke-direct {p0, v0}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->checkPicPath(Ljava/lang/String;)Z
a=0;// 
a=0;//     .line 26
a=0;//     :cond_0
a=0;//     #v0=(Conflicted);
...
a=0;// .end method
a=0;// 
a=0;// .method public static getInstance(Ljava/lang/String;)Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;
a=0;//     .locals 2
a=0;//     .param p0, "path"    # Ljava/lang/String;
a=0;// 
a=0;//     .prologue
a=0;//     .line 34
a=0;//     sget-object v0, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->instance:Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;
a=0;// 
a=0;//     #v0=(Reference,Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;);
a=0;//     if-nez v0, :cond_1
a=0;// 
a=0;//     .line 35
a=0;//     const-class v1, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;
a=0;// 
...
a=0;// 
a=0;//     .line 37
a=0;//     new-instance v0, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;
a=0;// 
a=0;//     #v0=(UninitRef,Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;);
a=0;//     invoke-direct {v0, p0}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;-><init>(Ljava/lang/String;)V
a=0;// 
a=0;//     #v0=(Reference,Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;);
a=0;//     sput-object v0, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->instance:Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;
a=0;// 
a=0;//     .line 35
a=0;//     :cond_0
a=0;//     monitor-exit v1
...
a=0;//     iget-object v4, p0, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->rootPath:Ljava/lang/String;
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     invoke-virtual {p0, p1}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->get(Ljava/lang/String;)Lorg/json/JSONArray;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     invoke-virtual {p0, p1, p2}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->get(Ljava/lang/String;Lcom/twocloo/base/cache/KeyCreater;)Lorg/json/JSONArray;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,Lorg/json/JSONArray;);
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     invoke-virtual {p0, p1, p2, p3, p4}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->get(Ljava/lang/String;Lcom/twocloo/base/cache/KeyCreater;J)Lorg/json/JSONArray;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,Lorg/json/JSONArray;);
...
a=0;// .end method
a=0;// 
a=0;// .method public get(Ljava/lang/String;)Lorg/json/JSONArray;
a=0;//     .locals 1
a=0;//     .param p1, "url"    # Ljava/lang/String;
a=0;// 
a=0;//     .prologue
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     invoke-virtual {p0, p1, v0}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->get(Ljava/lang/String;Lcom/twocloo/base/cache/KeyCreater;)Lorg/json/JSONArray;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,Lorg/json/JSONArray;);
...
a=0;// .end method
a=0;// 
a=0;// .method public get(Ljava/lang/String;Lcom/twocloo/base/cache/KeyCreater;)Lorg/json/JSONArray;
a=0;//     .locals 2
a=0;//     .param p1, "url"    # Ljava/lang/String;
...
a=0;//     invoke-virtual {p0, p1, p2, v0, v1}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->get(Ljava/lang/String;Lcom/twocloo/base/cache/KeyCreater;J)Lorg/json/JSONArray;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,Lorg/json/JSONArray;);
...
a=0;// .end method
a=0;// 
a=0;// .method public get(Ljava/lang/String;Lcom/twocloo/base/cache/KeyCreater;J)Lorg/json/JSONArray;
a=0;//     .locals 14
a=0;//     .param p1, "url"    # Ljava/lang/String;
a=0;//     .param p2, "keyCreater"    # Lcom/twocloo/base/cache/KeyCreater;
...
a=0;//     .line 100
a=0;//     :goto_0
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v4=(Conflicted);v5=(Conflicted);v6=(Reference,Lorg/json/JSONArray;);v7=(Conflicted);v8=(Conflicted);v9=(Conflicted);v10=(Conflicted);v11=(Conflicted);v12=(Conflicted);v13=(Conflicted);
...
a=0;//     iget-object v12, p0, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->rootPath:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     .line 75
a=0;//     .local v6, "jo":Lorg/json/JSONArray;
a=0;//     #v6=(Null);
...
a=0;//     :cond_2
a=0;//     :goto_2
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v6=(Reference,Lorg/json/JSONArray;);v7=(Conflicted);v8=(Conflicted);v9=(Conflicted);v10=(Conflicted);v11=(Conflicted);v12=(Conflicted);v13=(Conflicted);
...
a=0;//     .end local v6    # "jo":Lorg/json/JSONArray;
a=0;//     :cond_3
...
a=0;//     .restart local v6    # "jo":Lorg/json/JSONArray;
...
a=0;// 
a=0;//     .line 88
a=0;//     new-instance v7, Lorg/json/JSONArray;
a=0;// 
a=0;//     #v7=(UninitRef,Lorg/json/JSONArray;);
a=0;//     invoke-direct {v7, v10}, Lorg/json/JSONArray;-><init>(Ljava/lang/String;)V
a=0;//     :try_end_0
a=0;//     .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
a=0;// 
a=0;//     .end local v6    # "jo":Lorg/json/JSONArray;
a=0;//     .local v7, "jo":Lorg/json/JSONArray;
a=0;//     #v7=(Reference,Lorg/json/JSONArray;);
a=0;//     move-object v6, v7
a=0;// 
a=0;//     .line 89
a=0;//     .end local v7    # "jo":Lorg/json/JSONArray;
a=0;//     .restart local v6    # "jo":Lorg/json/JSONArray;
...
a=0;//     :cond_5
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v6=(Reference,Lorg/json/JSONArray;);v8=(Conflicted);v9=(Conflicted);v10=(Conflicted);v11=(Conflicted);v12=(Conflicted);v13=(Conflicted);
a=0;//     new-instance v11, Ljava/lang/StringBuilder;
a=0;// 
a=0;//     #v11=(UninitRef,Ljava/lang/StringBuilder;);
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     check-cast p2, Lorg/json/JSONArray;
a=0;// 
a=0;//     invoke-virtual {p0, p1, p2}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->put(Ljava/lang/String;Lorg/json/JSONArray;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;// 
a=0;//     invoke-virtual {p0, p1, p2, p3}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->put(Ljava/lang/String;Lorg/json/JSONArray;Lcom/twocloo/base/cache/Filter;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;//     check-cast p3, Lcom/twocloo/base/cache/Filter;
a=0;// 
a=0;//     invoke-virtual {p0, p1, p2, p3, p4}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->put(Ljava/lang/String;Lorg/json/JSONArray;Lcom/twocloo/base/cache/Filter;Lcom/twocloo/base/cache/KeyCreater;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;// .end method
a=0;// 
a=0;// .method public put(Ljava/lang/String;Lorg/json/JSONArray;)Z
a=0;//     .locals 1
a=0;//     .param p1, "url"    # Ljava/lang/String;
a=0;//     .param p2, "viewData"    # Lorg/json/JSONArray;
a=0;// 
a=0;//     .prologue
a=0;//     const/4 v0, 0x0
a=0;// 
a=0;//     .line 107
a=0;//     #v0=(Null);
a=0;//     invoke-virtual {p0, p1, p2, v0, v0}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->put(Ljava/lang/String;Lorg/json/JSONArray;Lcom/twocloo/base/cache/Filter;Lcom/twocloo/base/cache/KeyCreater;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;// .end method
a=0;// 
a=0;// .method public put(Ljava/lang/String;Lorg/json/JSONArray;Lcom/twocloo/base/cache/Filter;)Z
a=0;//     .locals 1
a=0;//     .param p1, "url"    # Ljava/lang/String;
a=0;//     .param p2, "viewData"    # Lorg/json/JSONArray;
a=0;//     .annotation system Ldalvik/annotation/Signature;
...
a=0;//     .prologue
a=0;//     .line 114
a=0;//     .local p3, "filter":Lcom/twocloo/base/cache/Filter;, "Lcom/twocloo/base/cache/Filter<Lorg/json/JSONArray;>;"
a=0;//     const/4 v0, 0x0
a=0;// 
a=0;//     #v0=(Null);
a=0;//     invoke-virtual {p0, p1, p2, p3, v0}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->put(Ljava/lang/String;Lorg/json/JSONArray;Lcom/twocloo/base/cache/Filter;Lcom/twocloo/base/cache/KeyCreater;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;// .end method
a=0;// 
a=0;// .method public put(Ljava/lang/String;Lorg/json/JSONArray;Lcom/twocloo/base/cache/Filter;Lcom/twocloo/base/cache/KeyCreater;)Z
a=0;//     .locals 7
a=0;//     .param p1, "url"    # Ljava/lang/String;
a=0;//     .param p2, "viewData"    # Lorg/json/JSONArray;
...
a=0;//     invoke-virtual {p0}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->getAvailableMemorySize()J
a=0;// 
...
a=0;// 
a=0;//     .line 130
a=0;//     iget-object v3, p0, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->rootPath:Ljava/lang/String;
a=0;// 
a=0;//     #v3=(Reference,Ljava/lang/String;);
a=0;//     invoke-direct {p0, v3}, Lcom/twocloo/base/cache/viewdata/JSONArraySDCache;->cleanFolder(Ljava/lang/String;)V
a=0;// 
a=0;//     .line 132
a=0;//     :cond_3
a=0;//     #v3=(Conflicted);
...
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     invoke-virtual {p2}, Lorg/json/JSONArray;->toString()Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v3
a=0;// 
