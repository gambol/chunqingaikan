package com.twocloo.com.cn.http; class MyAutoUpdate$2 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/http/MyAutoUpdate$2;
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/http/MyAutoUpdate$2;->this$0:Lcom/twocloo/com/cn/http/MyAutoUpdate;
a=0;// 
a=0;//     .line 112
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/http/MyAutoUpdate$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
