package com.twocloo.com.cn.http; class HttpImpl$3 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/http/HttpImpl$3;
...
a=0;//     value = Lcom/twocloo/com/cn/http/HttpImpl;->prepareVipText(Landroid/app/Activity;Ljava/lang/String;)Lcom/twocloo/com/cn/beans/RDBook;
a=0;// .end annotation
a=0;// 
...
a=0;// 
a=0;//     .line 1
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/http/HttpImpl$3;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lcom/twocloo/com/cn/http/HttpImpl$3;->accept(Lorg/json/JSONObject;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
