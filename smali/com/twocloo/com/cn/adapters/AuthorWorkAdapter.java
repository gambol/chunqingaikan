package com.twocloo.com.cn.adapters; class AuthorWorkAdapter { void a() { int a;
a=0;// .class public Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;
a=0;// .super Landroid/widget/BaseAdapter;
a=0;// .source "AuthorWorkAdapter.java"
a=0;// 
a=0;// 
a=0;// # annotations
a=0;// .annotation system Ldalvik/annotation/MemberClasses;
a=0;//     value = {
a=0;//         Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;
a=0;//     }
a=0;// .end annotation
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     .line 43
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;);
...
a=0;//     iput-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->VIEW_CACHE:Lcom/twocloo/base/cache/Cache;
a=0;// 
a=0;//     .line 45
a=0;//     const/4 v0, 0x0
a=0;// 
a=0;//     #v0=(Null);
a=0;//     iput-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->mInflater:Landroid/view/LayoutInflater;
a=0;// 
a=0;//     .line 50
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->context:Landroid/app/Activity;
a=0;// 
a=0;//     .line 51
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->newBooks:Ljava/util/ArrayList;
a=0;// 
a=0;//     .line 52
...
a=0;//     iput-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->netType:Lcom/twocloo/base/common/NetType;
a=0;// 
a=0;//     .line 53
...
a=0;//     iput-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->mQueue:Lcom/android/volley/RequestQueue;
a=0;// 
a=0;//     .line 57
a=0;//     new-instance v0, Lcom/android/volley/toolbox/ImageLoader;
a=0;// 
a=0;//     #v0=(UninitRef,Lcom/android/volley/toolbox/ImageLoader;);
a=0;//     iget-object v1, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->mQueue:Lcom/android/volley/RequestQueue;
a=0;// 
...
a=0;//     iput-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->mImageLoader:Lcom/android/volley/toolbox/ImageLoader;
a=0;// 
a=0;//     .line 59
a=0;//     :cond_0
...
a=0;//     .prologue
a=0;//     .line 62
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->newBooks:Ljava/util/ArrayList;
a=0;// 
...
a=0;// 
a=0;//     .line 79
a=0;//     .local v8, "holder":Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;
a=0;//     #v8=(Null);
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->VIEW_CACHE:Lcom/twocloo/base/cache/Cache;
a=0;// 
...
a=0;// 
a=0;//     .line 83
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->mInflater:Landroid/view/LayoutInflater;
a=0;// 
a=0;//     sget v1, Lcom/twocloo/com/cn/R$layout;->book_item:I
a=0;// 
a=0;//     #v1=(Integer);
...
a=0;// 
a=0;//     .line 84
a=0;//     new-instance v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;
a=0;// 
a=0;//     .end local v8    # "holder":Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;
a=0;//     #v8=(UninitRef,Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;);
a=0;//     invoke-direct {v8, v2}, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;-><init>(Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;)V
a=0;// 
a=0;//     .line 85
a=0;//     .restart local v8    # "holder":Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;
a=0;//     #v8=(Reference,Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;);
...
a=0;// 
a=0;//     iput-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->imgContainer:Landroid/widget/ImageView;
a=0;// 
a=0;//     .line 86
...
a=0;// 
a=0;//     iput-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->title:Landroid/widget/TextView;
a=0;// 
a=0;//     .line 87
...
a=0;//     check-cast v0, Landroid/widget/TextView;
a=0;// 
a=0;//     iput-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->clickNum:Landroid/widget/TextView;
a=0;// 
a=0;//     .line 88
...
a=0;//     check-cast v0, Landroid/widget/TextView;
a=0;// 
a=0;//     iput-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->type:Landroid/widget/TextView;
a=0;// 
a=0;//     .line 89
...
a=0;//     check-cast v0, Landroid/widget/TextView;
a=0;// 
a=0;//     iput-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->description:Landroid/widget/TextView;
a=0;// 
a=0;//     .line 90
...
a=0;// 
a=0;//     #v0=(Reference,Landroid/view/View;);
a=0;//     iput-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->line:Landroid/view/View;
a=0;// 
a=0;//     .line 91
...
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->context:Landroid/app/Activity;
a=0;// 
a=0;//     iget-object v1, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->line:Landroid/view/View;
a=0;// 
a=0;//     #v1=(Reference,Landroid/view/View;);
a=0;//     invoke-static {v0, v1}, Lcom/twocloo/com/cn/utils/CommonUtils;->setMoreSetFengexianBackgroundByDayOrNight(Landroid/app/Activity;Landroid/view/View;)V
a=0;// 
a=0;//     .line 101
...
a=0;// 
a=0;//     .line 103
a=0;//     iget-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->title:Landroid/widget/TextView;
a=0;// 
...
a=0;//     .line 106
a=0;//     :goto_1
a=0;//     iget-object v1, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->clickNum:Landroid/widget/TextView;
a=0;// 
...
a=0;// 
a=0;//     .line 108
a=0;//     iget-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->type:Landroid/widget/TextView;
a=0;// 
...
a=0;// 
a=0;//     .line 109
a=0;//     iget-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->description:Landroid/widget/TextView;
a=0;// 
...
a=0;// 
a=0;//     .line 112
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->netType:Lcom/twocloo/base/common/NetType;
a=0;// 
a=0;//     #v0=(Reference,Lcom/twocloo/base/common/NetType;);
...
a=0;// 
a=0;//     .line 113
a=0;//     iget-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->imgContainer:Landroid/widget/ImageView;
a=0;// 
...
a=0;//     check-cast v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;
a=0;// 
a=0;//     .restart local v8    # "holder":Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;
a=0;//     goto/16 :goto_0
a=0;// 
...
a=0;//     :cond_1
a=0;//     #v0=(Integer);v6=(Reference,Lcom/twocloo/com/cn/beans/NewBook;);v11=(Reference,Ljava/lang/String;);
a=0;//     iget-object v0, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->title:Landroid/widget/TextView;
a=0;// 
a=0;//     #v0=(Reference,Landroid/widget/TextView;);
a=0;//     new-instance v1, Ljava/lang/StringBuilder;
...
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter;->mImageLoader:Lcom/android/volley/toolbox/ImageLoader;
a=0;// 
a=0;//     invoke-virtual {v6}, Lcom/twocloo/com/cn/beans/NewBook;->getImgURL()Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     iget-object v2, v8, Lcom/twocloo/com/cn/adapters/AuthorWorkAdapter$ViewHolder;->imgContainer:Landroid/widget/ImageView;
a=0;// 
