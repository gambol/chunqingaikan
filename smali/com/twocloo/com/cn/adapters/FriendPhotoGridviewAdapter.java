package com.twocloo.com.cn.adapters; class FriendPhotoGridviewAdapter { void a() { int a;
a=0;// .class public Lcom/twocloo/com/cn/adapters/FriendPhotoGridviewAdapter;
a=0;// .super Landroid/widget/BaseAdapter;
a=0;// .source "FriendPhotoGridviewAdapter.java"
a=0;// 
a=0;// 
a=0;// # instance fields
...
a=0;// 
a=0;//     .line 17
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/adapters/FriendPhotoGridviewAdapter;);
...
a=0;//     iput-object v0, p0, Lcom/twocloo/com/cn/adapters/FriendPhotoGridviewAdapter;->list:Ljava/util/ArrayList;
a=0;// 
a=0;//     .line 20
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/adapters/FriendPhotoGridviewAdapter;->context:Landroid/content/Context;
a=0;// 
a=0;//     .line 21
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/adapters/FriendPhotoGridviewAdapter;->list:Ljava/util/ArrayList;
a=0;// 
a=0;//     .line 22
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 26
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/FriendPhotoGridviewAdapter;->list:Ljava/util/ArrayList;
a=0;// 
a=0;//     #v0=(Reference,Ljava/util/ArrayList;);
...
a=0;// 
a=0;//     .line 44
a=0;//     iget-object v2, p0, Lcom/twocloo/com/cn/adapters/FriendPhotoGridviewAdapter;->context:Landroid/content/Context;
a=0;// 
