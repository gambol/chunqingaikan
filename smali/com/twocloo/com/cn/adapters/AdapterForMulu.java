package com.twocloo.com.cn.adapters; class AdapterForMulu { void a() { int a;
a=0;// .class public Lcom/twocloo/com/cn/adapters/AdapterForMulu;
a=0;// .super Landroid/widget/BaseAdapter;
a=0;// .source "AdapterForMulu.java"
a=0;// 
a=0;// 
a=0;// # annotations
a=0;// .annotation system Ldalvik/annotation/MemberClasses;
a=0;//     value = {
a=0;//         Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;
a=0;//     }
a=0;// .end annotation
a=0;// 
a=0;// 
...
a=0;// 
a=0;// .field private final datas:Ljava/util/ArrayList;
...
a=0;// 
a=0;// # direct methods
a=0;// .method public constructor <init>(Landroid/app/Activity;Ljava/util/ArrayList;Ljava/lang/String;Ljava/util/HashSet;)V
a=0;//     .locals 0
...
a=0;//     .prologue
a=0;//     .line 34
a=0;//     .local p2, "datas":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/twocloo/com/cn/beans/Chapterinfo;>;"
a=0;//     .local p4, "orderedSet":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
a=0;//     invoke-direct {p0}, Landroid/widget/BaseAdapter;-><init>()V
a=0;// 
a=0;//     .line 35
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/adapters/AdapterForMulu;);
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->act:Landroid/app/Activity;
a=0;// 
a=0;//     .line 36
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->datas:Ljava/util/ArrayList;
a=0;// 
a=0;//     .line 37
a=0;//     iput-object p4, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->orderedChapterTextidSet:Ljava/util/HashSet;
a=0;// 
a=0;//     .line 38
a=0;//     iput-object p3, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->nowtextid:Ljava/lang/String;
a=0;// 
a=0;//     .line 39
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 43
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->datas:Ljava/util/ArrayList;
a=0;// 
...
a=0;//     .local v0, "i":I
a=0;//     #v0=(Null);
a=0;//     iget-object v2, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->datas:Ljava/util/ArrayList;
a=0;// 
...
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->nowtextid:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     .line 60
a=0;//     new-instance v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;
a=0;// 
a=0;//     #v1=(UninitRef,Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;);
a=0;//     invoke-direct {v1, v5}, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;-><init>(Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;)V
a=0;// 
a=0;//     .line 61
a=0;//     .local v1, "tag":Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;
a=0;//     #v1=(Reference,Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;);
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->act:Landroid/app/Activity;
a=0;// 
...
a=0;// 
a=0;//     iput-object v3, v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;->chapterName:Landroid/widget/TextView;
a=0;// 
a=0;//     .line 63
...
a=0;//     check-cast v3, Landroid/widget/TextView;
a=0;// 
a=0;//     iput-object v3, v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;->vip:Landroid/widget/TextView;
a=0;// 
a=0;//     .line 64
...
a=0;// 
a=0;//     iput-object v3, v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;->continueReadLayout:Landroid/widget/LinearLayout;
a=0;// 
a=0;//     .line 65
...
a=0;// 
a=0;//     #v3=(Reference,Landroid/view/View;);
a=0;//     iput-object v3, v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;->mululine:Landroid/view/View;
a=0;// 
a=0;//     .line 66
...
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->datas:Ljava/util/ArrayList;
a=0;// 
...
a=0;//     iget-object v3, v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;->chapterName:Landroid/widget/TextView;
a=0;// 
...
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->act:Landroid/app/Activity;
a=0;// 
a=0;//     iget-object v4, v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;->mululine:Landroid/view/View;
a=0;// 
a=0;//     #v4=(Reference,Landroid/view/View;);
a=0;//     invoke-static {v3, v4}, Lcom/twocloo/com/cn/utils/CommonUtils;->setMoreSetFengexianBackgroundByDayOrNight(Landroid/app/Activity;Landroid/view/View;)V
a=0;// 
a=0;//     .line 78
...
a=0;//     const/16 v4, 0xcc
a=0;// 
a=0;//     #v4=(PosShort);
a=0;//     invoke-static {v4, v6, v6}, Landroid/graphics/Color;->rgb(III)I
a=0;// 
a=0;//     move-result v4
a=0;// 
a=0;//     #v4=(Integer);
...
a=0;// 
a=0;//     .line 80
a=0;//     iget-object v3, v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;->vip:Landroid/widget/TextView;
a=0;// 
a=0;//     invoke-virtual {v3, v7}, Landroid/widget/TextView;->setVisibility(I)V
a=0;// 
a=0;//     .line 81
a=0;//     iget-object v3, v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;->continueReadLayout:Landroid/widget/LinearLayout;
a=0;// 
...
a=0;// 
a=0;//     .line 90
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->orderedChapterTextidSet:Ljava/util/HashSet;
a=0;// 
...
a=0;//     .end local v1    # "tag":Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;
a=0;//     :cond_1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/Object;);
a=0;//     check-cast v1, Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;
a=0;// 
a=0;//     .restart local v1    # "tag":Lcom/twocloo/com/cn/adapters/AdapterForMulu$ShubenmuluHolder;
a=0;//     goto :goto_0
a=0;// 
a=0;//     .line 84
...
a=0;// 
a=0;//     #v3=(Reference,Landroid/widget/TextView;);
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/adapters/AdapterForMulu;->act:Landroid/app/Activity;
a=0;// 
a=0;//     invoke-virtual {v4}, Landroid/app/Activity;->getResources()Landroid/content/res/Resources;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
