package com.twocloo.com.cn.adapters; class AdapterForLinearLayout$1 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;
...
a=0;// 
a=0;// # direct methods
a=0;// .method constructor <init>(Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;Lcom/twocloo/com/cn/beans/Shuping_maininfo;Ljava/lang/String;)V
a=0;//     .locals 0
a=0;// 
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->this$0:Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;
a=0;// 
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->val$info:Lcom/twocloo/com/cn/beans/Shuping_maininfo;
a=0;// 
a=0;//     iput-object p3, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->val$data:Ljava/lang/String;
a=0;// 
a=0;//     .line 122
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 124
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->this$0:Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;
a=0;// 
a=0;//     #v3=(Reference,Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;);
a=0;//     invoke-static {v3}, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;->access$0(Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;)Landroid/app/Activity;
a=0;// 
...
a=0;//     move-result-object v3
a=0;// 
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->this$0:Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;
a=0;// 
a=0;//     #v4=(Reference,Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;);
a=0;//     invoke-static {v4}, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;->access$0(Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;)Landroid/app/Activity;
a=0;// 
...
a=0;//     iget-object v5, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->val$info:Lcom/twocloo/com/cn/beans/Shuping_maininfo;
a=0;// 
...
a=0;//     iget-object v6, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->val$info:Lcom/twocloo/com/cn/beans/Shuping_maininfo;
a=0;// 
...
a=0;// 
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->val$info:Lcom/twocloo/com/cn/beans/Shuping_maininfo;
a=0;// 
...
a=0;// 
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->val$data:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v0, v3, v4}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V
a=0;// 
a=0;//     .line 134
...
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->this$0:Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;
a=0;// 
a=0;//     invoke-static {v4}, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;->access$1(Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     invoke-virtual {v0, v3, v4}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V
...
a=0;// 
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/adapters/AdapterForLinearLayout$1;->val$info:Lcom/twocloo/com/cn/beans/Shuping_maininfo;
a=0;// 
