package com.twocloo.com.cn.adapters; class ListViewNewAdapt$2 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->this$0:Lcom/twocloo/com/cn/adapters/ListViewNewAdapt;
a=0;// 
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->val$book:Lcom/twocloo/com/cn/beans/BFBook;
a=0;// 
a=0;//     iput p3, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->val$position:I
a=0;// 
a=0;//     .line 273
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 276
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->val$book:Lcom/twocloo/com/cn/beans/BFBook;
a=0;// 
...
a=0;//     const-string v3, ""
a=0;// 
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->val$book:Lcom/twocloo/com/cn/beans/BFBook;
a=0;// 
...
a=0;// 
a=0;//     #v3=(Reference,Ljava/util/HashMap;);
a=0;//     iget-object v5, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->val$book:Lcom/twocloo/com/cn/beans/BFBook;
a=0;// 
...
a=0;//     :cond_2
a=0;//     #v3=(Conflicted);
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->this$0:Lcom/twocloo/com/cn/adapters/ListViewNewAdapt;
a=0;// 
a=0;//     #v3=(Reference,Lcom/twocloo/com/cn/adapters/ListViewNewAdapt;);
a=0;//     iget v4, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->val$position:I
a=0;// 
a=0;//     #v4=(Integer);
...
a=0;//     iget v3, p0, Lcom/twocloo/com/cn/adapters/ListViewNewAdapt$2;->val$position:I
a=0;// 
a=0;//     #v3=(Integer);
