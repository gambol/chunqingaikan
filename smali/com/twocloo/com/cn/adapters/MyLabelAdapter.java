package com.twocloo.com.cn.adapters; class MyLabelAdapter { void a() { int a;
a=0;// .class public Lcom/twocloo/com/cn/adapters/MyLabelAdapter;
a=0;// .super Landroid/widget/BaseAdapter;
a=0;// .source "MyLabelAdapter.java"
a=0;// 
a=0;// 
a=0;// # instance fields
...
a=0;// 
a=0;//     .line 30
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/adapters/MyLabelAdapter;);
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/adapters/MyLabelAdapter;->context:Landroid/content/Context;
a=0;// 
a=0;//     .line 31
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/adapters/MyLabelAdapter;->list:Ljava/util/ArrayList;
a=0;// 
a=0;//     .line 32
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 36
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/adapters/MyLabelAdapter;->list:Ljava/util/ArrayList;
a=0;// 
...
a=0;// 
a=0;//     .line 53
a=0;//     iget-object v2, p0, Lcom/twocloo/com/cn/adapters/MyLabelAdapter;->context:Landroid/content/Context;
a=0;// 
...
a=0;// 
a=0;//     sget v3, Lcom/twocloo/com/cn/R$layout;->my_biaoqian_item:I
a=0;// 
a=0;//     #v3=(Integer);
a=0;//     const/4 v4, 0x0
a=0;// 
...
a=0;//     sget v2, Lcom/twocloo/com/cn/R$id;->biaoqian:I
a=0;// 
a=0;//     #v2=(Integer);
...
a=0;//     iget-object v2, p0, Lcom/twocloo/com/cn/adapters/MyLabelAdapter;->list:Ljava/util/ArrayList;
a=0;// 
