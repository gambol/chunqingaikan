package com.twocloo.com.cn.common; class JavaScript$6 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/common/JavaScript$6;
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/common/JavaScript$6;->this$0:Lcom/twocloo/com/cn/common/JavaScript;
a=0;// 
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/common/JavaScript$6;->val$Url:Ljava/lang/String;
a=0;// 
a=0;//     .line 717
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/common/JavaScript$6;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 720
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/common/JavaScript$6;->val$Url:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     .line 728
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/common/JavaScript$6;->this$0:Lcom/twocloo/com/cn/common/JavaScript;
a=0;// 
...
a=0;// 
a=0;//     .line 733
a=0;//     .end local v2    # "message":Ljava/lang/String;
