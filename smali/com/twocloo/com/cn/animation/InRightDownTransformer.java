package com.twocloo.com.cn.animation; class InRightDownTransformer { void a() { int a;
a=0;// .class public Lcom/twocloo/com/cn/animation/InRightDownTransformer;
a=0;// .super Ljava/lang/Object;
a=0;// .source "InRightDownTransformer.java"
a=0;// 
a=0;// # interfaces
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/animation/InRightDownTransformer;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     .line 21
a=0;//     invoke-virtual {p1, v3}, Landroid/view/View;->setTranslationY(F)V
a=0;// 
a=0;//     .line 38
a=0;//     :goto_0
a=0;//     #v1=(Float);
