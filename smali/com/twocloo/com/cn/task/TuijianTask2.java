package com.twocloo.com.cn.task; class TuijianTask2 { void a() { int a;
a=0;// .class public Lcom/twocloo/com/cn/task/TuijianTask2;
a=0;// .super Lcom/twocloo/base/sync/EasyTask;
a=0;// .source "TuijianTask2.java"
a=0;// 
a=0;// 
a=0;// # annotations
...
a=0;// 
a=0;//     .line 53
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/task/TuijianTask2;);
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->act:Landroid/app/Activity;
a=0;// 
a=0;//     .line 54
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->url:Ljava/lang/String;
a=0;// 
a=0;//     .line 55
a=0;//     iput-object p5, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->aid:Ljava/lang/String;
a=0;// 
a=0;//     .line 56
a=0;//     iput-object p3, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->uid:Ljava/lang/String;
a=0;// 
a=0;//     .line 57
a=0;//     iput-object p4, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->token:Ljava/lang/String;
a=0;// 
a=0;//     .line 58
a=0;//     return-void
a=0;// .end method
...
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lcom/twocloo/com/cn/task/TuijianTask2;->doInBackground([Ljava/lang/Void;)Ljava/lang/String;
a=0;// 
...
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->url:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     #v7=(Null);
a=0;//     iget-object v8, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->aid:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     #v7=(One);
a=0;//     iget-object v8, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->token:Ljava/lang/String;
a=0;// 
a=0;//     aput-object v8, v6, v7
a=0;// 
...
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->caller:Ljava/lang/Object;
a=0;// 
...
a=0;// 
a=0;//     #v3=(Reference,Ljava/lang/String;);
a=0;//     iput-object v3, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->result:Ljava/lang/String;
a=0;// 
a=0;//     .line 73
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->result:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lcom/twocloo/com/cn/task/TuijianTask2;->onPostExecute(Ljava/lang/String;)V
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .line 90
a=0;//     #v3=(Null);
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->pd:Landroid/app/ProgressDialog;
a=0;// 
...
a=0;// 
a=0;//     .line 95
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->caller:Ljava/lang/Object;
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/Object;);
a=0;//     check-cast v0, Landroid/content/Context;
a=0;// 
a=0;//     iget-object v1, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->uid:Ljava/lang/String;
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     iget-object v2, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->aid:Ljava/lang/String;
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, p0, Lcom/twocloo/com/cn/task/TuijianTask2;->pd:Landroid/app/ProgressDialog;
a=0;// 
a=0;//     .line 65
a=0;//     :cond_0
a=0;//     #v1=(Conflicted);
