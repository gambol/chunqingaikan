package com.twocloo.com.cn.task; class RechargeYDmmTask { void a() { int a;
a=0;// .class public Lcom/twocloo/com/cn/task/RechargeYDmmTask;
a=0;// .super Lcom/twocloo/base/sync/EasyTask;
a=0;// .source "RechargeYDmmTask.java"
a=0;// 
a=0;// 
a=0;// # annotations
...
a=0;// 
a=0;// .field private tradeid:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;// # direct methods
a=0;// .method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
a=0;//     .locals 0
...
a=0;//     .param p7, "tradeId"    # Ljava/lang/String;
a=0;//     .param p8, "orderType"    # Ljava/lang/String;
a=0;// 
a=0;//     .prologue
a=0;//     .line 32
...
a=0;// 
a=0;//     .line 33
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/task/RechargeYDmmTask;);
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->ctx:Landroid/content/Context;
a=0;// 
a=0;//     .line 34
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->url:Ljava/lang/String;
a=0;// 
a=0;//     .line 35
a=0;//     iput-object p3, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->uid:Ljava/lang/String;
a=0;// 
a=0;//     .line 36
a=0;//     iput-object p4, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->token:Ljava/lang/String;
a=0;// 
a=0;//     .line 37
a=0;//     iput-object p5, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->orderid:Ljava/lang/String;
a=0;// 
a=0;//     .line 38
a=0;//     iput-object p6, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->paycode:Ljava/lang/String;
a=0;// 
a=0;//     .line 39
a=0;//     iput-object p7, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->tradeid:Ljava/lang/String;
a=0;// 
a=0;//     .line 40
a=0;//     iput-object p8, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->ordertype:Ljava/lang/String;
a=0;// 
a=0;//     .line 41
a=0;//     return-void
a=0;// .end method
...
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->url:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     #v7=(Null);
a=0;//     iget-object v8, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->uid:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     #v7=(One);
a=0;//     iget-object v8, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->orderid:Ljava/lang/String;
a=0;// 
a=0;//     aput-object v8, v6, v7
a=0;// 
a=0;//     const/4 v7, 0x2
a=0;// 
a=0;//     #v7=(PosByte);
a=0;//     iget-object v8, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->paycode:Ljava/lang/String;
a=0;// 
a=0;//     aput-object v8, v6, v7
a=0;// 
a=0;//     const/4 v7, 0x3
a=0;// 
a=0;//     iget-object v8, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->tradeid:Ljava/lang/String;
a=0;// 
a=0;//     aput-object v8, v6, v7
a=0;// 
a=0;//     const/4 v7, 0x4
a=0;// 
a=0;//     iget-object v8, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->ordertype:Ljava/lang/String;
a=0;// 
a=0;//     aput-object v8, v6, v7
a=0;// 
...
a=0;//     iget-object v4, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->ctx:Landroid/content/Context;
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->doInBackground([Ljava/lang/Void;)Ljava/lang/Boolean;
a=0;// 
...
a=0;// 
a=0;//     .line 73
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->ctx:Landroid/content/Context;
a=0;// 
...
a=0;// 
a=0;//     invoke-virtual {p0, p1}, Lcom/twocloo/com/cn/task/RechargeYDmmTask;->onPostExecute(Ljava/lang/Boolean;)V
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
