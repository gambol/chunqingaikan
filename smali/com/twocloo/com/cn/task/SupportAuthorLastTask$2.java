package com.twocloo.com.cn.task; class SupportAuthorLastTask$2 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/task/SupportAuthorLastTask$2;
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/task/SupportAuthorLastTask$2;->this$0:Lcom/twocloo/com/cn/task/SupportAuthorLastTask;
a=0;// 
a=0;//     .line 85
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/task/SupportAuthorLastTask$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
