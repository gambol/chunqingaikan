package com.twocloo.com.cn.beans.orm; class MonthTicketRecord { void a() { int a;
a=0;// .class public Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;
a=0;// .super Ljava/lang/Object;
a=0;// .source "MonthTicketRecord.java"
a=0;// 
a=0;// # interfaces
...
a=0;//     tableName = "month_ticket_record"
a=0;// .end annotation
a=0;// 
a=0;// 
a=0;// # static fields
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 80
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;->addTime:Ljava/util/Date;
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 65
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;->bookId:Ljava/lang/String;
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 35
a=0;//     iget v0, p0, Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;->id:I
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     return v0
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 50
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;->userId:Ljava/lang/String;
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     return-object v0
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 88
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;->addTime:Ljava/util/Date;
a=0;// 
a=0;//     .line 89
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 73
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;->bookId:Ljava/lang/String;
a=0;// 
a=0;//     .line 74
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 43
a=0;//     iput p1, p0, Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;->id:I
a=0;// 
a=0;//     .line 44
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 58
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/beans/orm/MonthTicketRecord;->userId:Ljava/lang/String;
a=0;// 
a=0;//     .line 59
a=0;//     return-void
a=0;// .end method
