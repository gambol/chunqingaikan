package com.twocloo.com.cn.beans; class WheelMain$1 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/beans/WheelMain$1;
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/beans/WheelMain$1;->this$0:Lcom/twocloo/com/cn/beans/WheelMain;
a=0;// 
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/beans/WheelMain$1;->val$list_big:Ljava/util/List;
a=0;// 
a=0;//     iput-object p3, p0, Lcom/twocloo/com/cn/beans/WheelMain$1;->val$list_little:Ljava/util/List;
a=0;// 
a=0;//     .line 136
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/beans/WheelMain$1;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     add-int v0, p3, v1
a=0;// 
a=0;//     .line 140
a=0;//     .local v0, "year_num":I
a=0;//     #v0=(Integer);
a=0;//     iget-object v1, p0, Lcom/twocloo/com/cn/beans/WheelMain$1;->val$list_big:Ljava/util/List;
a=0;// 
a=0;//     #v1=(Reference,Ljava/util/List;);
a=0;//     iget-object v2, p0, Lcom/twocloo/com/cn/beans/WheelMain$1;->this$0:Lcom/twocloo/com/cn/beans/WheelMain;
a=0;// 
a=0;//     #v2=(Reference,Lcom/twocloo/com/cn/beans/WheelMain;);
a=0;//     invoke-static {v2}, Lcom/twocloo/com/cn/beans/WheelMain;->access$1(Lcom/twocloo/com/cn/beans/WheelMain;)Lcom/twocloo/com/cn/beans/WheelView;
a=0;// 
...
a=0;// 
a=0;//     .line 141
a=0;//     iget-object v1, p0, Lcom/twocloo/com/cn/beans/WheelMain$1;->this$0:Lcom/twocloo/com/cn/beans/WheelMain;
a=0;// 
...
a=0;//     iget-object v1, p0, Lcom/twocloo/com/cn/beans/WheelMain$1;->val$list_little:Ljava/util/List;
a=0;// 
a=0;//     #v1=(Reference,Ljava/util/List;);
a=0;//     iget-object v2, p0, Lcom/twocloo/com/cn/beans/WheelMain$1;->this$0:Lcom/twocloo/com/cn/beans/WheelMain;
a=0;// 
...
a=0;//     :cond_1
a=0;//     #v1=(Boolean);v3=(Uninit);
a=0;//     rem-int/lit8 v1, v0, 0x4
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     if-nez v1, :cond_2
a=0;// 
a=0;//     rem-int/lit8 v1, v0, 0x64
a=0;// 
a=0;//     if-nez v1, :cond_3
a=0;// 
a=0;//     :cond_2
a=0;//     rem-int/lit16 v1, v0, 0x190
a=0;// 
