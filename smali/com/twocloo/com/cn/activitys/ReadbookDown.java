...
a=0;// 
a=0;//     invoke-virtual {p0}, Lcom/twocloo/com/cn/activitys/ReadbookDown;->addAd()V
a=0;//     .line 66
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//
a=0;//    invoke-virtual {p0, v2}, Lcom/twocloo/com/cn/activitys/ReadbookDown;->findViewById(I)Landroid/view/View;
a=0;//
a=0;//    move-result-object v0
a=0;//
