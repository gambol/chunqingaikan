package com.twocloo.com.cn.activitys; class SettingActivity$2 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/activitys/SettingActivity$2;
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/activitys/SettingActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/SettingActivity;
a=0;// 
a=0;//     .line 117
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/activitys/SettingActivity$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     .line 121
a=0;//     iget-object v0, p0, Lcom/twocloo/com/cn/activitys/SettingActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/SettingActivity;
a=0;// 
a=0;//     #v0=(Reference,Lcom/twocloo/com/cn/activitys/SettingActivity;);
a=0;//     const/4 v1, 0x1
a=0;// 
a=0;//     #v1=(One);
a=0;//     invoke-static {v0, v1}, Lcom/twocloo/com/cn/common/LocalStore;->setPush(Landroid/content/Context;Z)V
a=0;// 
a=0;//     .line 125
a=0;//     :goto_0
a=0;//     #v1=(Boolean);
