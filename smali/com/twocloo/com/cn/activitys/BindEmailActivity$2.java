package com.twocloo.com.cn.activitys; class BindEmailActivity$2 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;
...
a=0;//     value = Lcom/twocloo/com/cn/activitys/BindEmailActivity;->onClick(Landroid/view/View;)V
a=0;// .end annotation
a=0;// 
...
a=0;// 
a=0;// # direct methods
a=0;// .method constructor <init>(Lcom/twocloo/com/cn/activitys/BindEmailActivity;Ljava/lang/String;Lcom/twocloo/com/cn/beans/User;Landroid/content/Intent;)V
a=0;//     .locals 0
a=0;// 
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/BindEmailActivity;
a=0;// 
a=0;//     iput-object p2, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->val$text:Ljava/lang/String;
a=0;// 
a=0;//     iput-object p3, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->val$user:Lcom/twocloo/com/cn/beans/User;
a=0;// 
a=0;//     iput-object p4, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->val$intent:Landroid/content/Intent;
a=0;// 
a=0;//     .line 83
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     const-string v6, "http://app.2cloo.com/user-bind_email?email="
a=0;// 
a=0;//     #v6=(Reference,Ljava/lang/String;);
a=0;//     invoke-direct {v5, v6}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V
a=0;// 
a=0;//     #v5=(Reference,Ljava/lang/StringBuilder;);
a=0;//     iget-object v6, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->val$text:Ljava/lang/String;
a=0;// 
...
a=0;//     move-result-object v5
a=0;// 
a=0;//     iget-object v6, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->val$user:Lcom/twocloo/com/cn/beans/User;
a=0;// 
...
a=0;//     move-result-object v5
a=0;// 
a=0;//     iget-object v6, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/BindEmailActivity;
a=0;// 
...
a=0;// 
a=0;//     .line 93
a=0;//     iget-object v5, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->val$intent:Landroid/content/Intent;
a=0;// 
a=0;//     #v5=(Reference,Landroid/content/Intent;);
a=0;//     const-string v6, "email"
a=0;// 
a=0;//     iget-object v7, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->val$text:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     .line 94
a=0;//     iget-object v5, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/BindEmailActivity;
a=0;// 
a=0;//     iget-object v6, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->val$intent:Landroid/content/Intent;
a=0;// 
a=0;//     invoke-virtual {v5, v6}, Lcom/twocloo/com/cn/activitys/BindEmailActivity;->startActivity(Landroid/content/Intent;)V
a=0;// 
a=0;//     .line 95
a=0;//     iget-object v5, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/BindEmailActivity;
a=0;// 
a=0;//     invoke-virtual {v5}, Lcom/twocloo/com/cn/activitys/BindEmailActivity;->finish()V
a=0;// 
a=0;//     .line 97
a=0;//     :cond_0
...
a=0;//     iget-object v5, p0, Lcom/twocloo/com/cn/activitys/BindEmailActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/BindEmailActivity;
a=0;// 
a=0;//     #v5=(Reference,Lcom/twocloo/com/cn/activitys/BindEmailActivity;);
a=0;//     invoke-static {v5}, Lcom/twocloo/com/cn/activitys/BindEmailActivity;->access$0(Lcom/twocloo/com/cn/activitys/BindEmailActivity;)Landroid/os/Handler;
a=0;// 
a=0;//     move-result-object v5
a=0;// 
