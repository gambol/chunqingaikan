package com.twocloo.com.cn.activitys; class SearchResultActivity$2 { void a() { int a;
a=0;// .class Lcom/twocloo/com/cn/activitys/SearchResultActivity$2;
...
a=0;//     value = Lcom/twocloo/com/cn/activitys/SearchResultActivity;->onCreate(Landroid/os/Bundle;)V
a=0;// .end annotation
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 1
a=0;//     iput-object p1, p0, Lcom/twocloo/com/cn/activitys/SearchResultActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/SearchResultActivity;
a=0;// 
a=0;//     .line 142
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloo/com/cn/activitys/SearchResultActivity$2;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     iget-object v3, p0, Lcom/twocloo/com/cn/activitys/SearchResultActivity$2;->this$0:Lcom/twocloo/com/cn/activitys/SearchResultActivity;
a=0;// 
...
a=0;// 
a=0;//     #v3=(Reference,Lcom/twocloo/com/cn/activitys/SearchResultActivity;);
a=0;//     invoke-virtual {v3, v2}, Lcom/twocloo/com/cn/activitys/SearchResultActivity;->startActivity(Landroid/content/Intent;)V
a=0;// 
a=0;//     .line 159
a=0;//     return-void
a=0;// .end method
