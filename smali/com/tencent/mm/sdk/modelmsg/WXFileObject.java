package com.tencent.mm.sdk.modelmsg; class WXFileObject { void a() { int a;
a=0;// .class public Lcom/tencent/mm/sdk/modelmsg/WXFileObject;
...
a=0;// 
a=0;// .field private static final TAG:Ljava/lang/String; = "MicroMsg.SDK.WXFileObject"
a=0;// 
a=0;// 
a=0;// # instance fields
a=0;// .field private contentLengthLimit:I
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/tencent/mm/sdk/modelmsg/WXFileObject;);
a=0;//     const/high16 v0, 0xa00000
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     iput v0, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->contentLengthLimit:I
a=0;// 
a=0;//     iput-object v1, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->fileData:[B
a=0;// 
a=0;//     iput-object v1, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->filePath:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     iput v0, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->contentLengthLimit:I
a=0;// 
a=0;//     iput-object p1, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->filePath:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     iput v0, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->contentLengthLimit:I
a=0;// 
a=0;//     iput-object p1, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->fileData:[B
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #v0=(Null);
a=0;//     iget-object v1, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->fileData:[B
a=0;// 
a=0;//     #v1=(Reference,[B);
...
a=0;//     :cond_0
a=0;//     #v1=(Conflicted);
a=0;//     iget-object v1, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->filePath:Ljava/lang/String;
a=0;// 
...
a=0;//     :cond_1
a=0;//     #v1=(Conflicted);
a=0;//     const-string v1, "MicroMsg.SDK.WXFileObject"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;// 
a=0;//     #v1=(Integer);
a=0;//     iget v2, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->contentLengthLimit:I
a=0;// 
a=0;//     #v2=(Integer);
...
a=0;//     iget-object v1, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->filePath:Ljava/lang/String;
a=0;// 
a=0;//     invoke-direct {p0, v1}, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->getFileSize(Ljava/lang/String;)I
a=0;// 
a=0;//     move-result v1
a=0;// 
a=0;//     #v1=(Integer);
...
a=0;// .end method
a=0;// 
a=0;// .method public setContentLengthLimit(I)V
a=0;//     .locals 0
a=0;// 
a=0;//     iput p1, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->contentLengthLimit:I
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     iput-object v0, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->fileData:[B
a=0;// 
a=0;//     const-string v0, "_wxfileobject_filePath"
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, p0, Lcom/tencent/mm/sdk/modelmsg/WXFileObject;->filePath:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
}}
