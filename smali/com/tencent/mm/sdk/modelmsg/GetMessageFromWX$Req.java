package com.tencent.mm.sdk.modelmsg; class GetMessageFromWX$Req { void a() { int a;
a=0;// .class public Lcom/tencent/mm/sdk/modelmsg/GetMessageFromWX$Req;
...
a=0;// 
a=0;// # instance fields
a=0;// .field public username:Ljava/lang/String;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/tencent/mm/sdk/modelmsg/GetMessageFromWX$Req;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/tencent/mm/sdk/modelmsg/GetMessageFromWX$Req;);
a=0;//     invoke-virtual {p0, p1}, Lcom/tencent/mm/sdk/modelmsg/GetMessageFromWX$Req;->fromBundle(Landroid/os/Bundle;)V
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
