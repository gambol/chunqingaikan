package com.tencent.mm.sdk.modelmsg; class WXWebpageObject { void a() { int a;
a=0;// .class public Lcom/tencent/mm/sdk/modelmsg/WXWebpageObject;
...
a=0;// 
a=0;// .field private static final TAG:Ljava/lang/String; = "MicroMsg.SDK.WXWebpageObject"
a=0;// 
a=0;// 
a=0;// # instance fields
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/tencent/mm/sdk/modelmsg/WXWebpageObject;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/tencent/mm/sdk/modelmsg/WXWebpageObject;);
a=0;//     iput-object p1, p0, Lcom/tencent/mm/sdk/modelmsg/WXWebpageObject;->webpageUrl:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .locals 2
a=0;// 
a=0;//     iget-object v0, p0, Lcom/tencent/mm/sdk/modelmsg/WXWebpageObject;->webpageUrl:Ljava/lang/String;
a=0;// 
...
a=0;//     const-string v0, "MicroMsg.SDK.WXWebpageObject"
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
...
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     iget-object v1, p0, Lcom/tencent/mm/sdk/modelmsg/WXWebpageObject;->webpageUrl:Ljava/lang/String;
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;// 
a=0;//     iput-object v0, p0, Lcom/tencent/mm/sdk/modelmsg/WXWebpageObject;->webpageUrl:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
}}
