package com.tencent.mm.sdk.openapi; class WXApiImplComm { void a() { int a;
a=0;// .class Lcom/tencent/mm/sdk/openapi/WXApiImplComm;
a=0;// .super Ljava/lang/Object;
a=0;// 
a=0;// 
a=0;// # static fields
a=0;// .field private static final TAG:Ljava/lang/String; = "MicroMsg.SDK.WXMsgImplComm"
a=0;// 
a=0;// .field private static final WX_APP_SIGNATURE:Ljava/lang/String; = ""
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/tencent/mm/sdk/openapi/WXApiImplComm;);
...
a=0;// .end method
a=0;// 
a=0;// .method public static isIntentFromWx(Landroid/content/Intent;Ljava/lang/String;)Z
a=0;//     .locals 2
a=0;// 
a=0;//     const/4 v0, 0x0
a=0;// 
...
a=0;//     const-string v1, "wx_token_key"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     invoke-virtual {p0, v1}, Landroid/content/Intent;->getStringExtra(Ljava/lang/String;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v1
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method public static validateAppSignature(Landroid/content/Context;[Landroid/content/pm/Signature;Z)Z
a=0;//     .locals 8
a=0;// 
a=0;//     const/4 v0, 0x1
a=0;// 
...
a=0;// 
a=0;//     const-string v1, "MicroMsg.SDK.WXMsgImplComm"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     const-string v2, "ignore wechat app signature validation"
a=0;// 
a=0;//     #v2=(Reference,Ljava/lang/String;);
a=0;//     invoke-static {v1, v2}, Lcom/tencent/mm/sdk/b/a;->c(Ljava/lang/String;Ljava/lang/String;)V
a=0;// 
a=0;//     :goto_0
...
a=0;// 
a=0;//     :cond_0
a=0;//     #v0=(One);v1=(Null);v2=(Uninit);v3=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Uninit);
...
a=0;// 
a=0;//     :goto_1
a=0;//     #v2=(Integer);v4=(Conflicted);v5=(Conflicted);v6=(Conflicted);v7=(Conflicted);
...
a=0;//     move-result-object v4
a=0;// 
a=0;//     const-string v5, "MicroMsg.SDK.WXMsgImplComm"
a=0;// 
a=0;//     #v5=(Reference,Ljava/lang/String;);
a=0;//     new-instance v6, Ljava/lang/StringBuilder;
a=0;// 
a=0;//     #v6=(UninitRef,Ljava/lang/StringBuilder;);
a=0;//     const-string v7, "check signature:"
a=0;// 
...
a=0;//     move-result-object v6
a=0;// 
a=0;//     invoke-static {v5, v6}, Lcom/tencent/mm/sdk/b/a;->c(Ljava/lang/String;Ljava/lang/String;)V
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method public static validateAppSignatureForPackage(Landroid/content/Context;Ljava/lang/String;Z)Z
a=0;//     .locals 2
a=0;// 
a=0;//     if-nez p2, :cond_0
a=0;// 
a=0;//     const-string v0, "MicroMsg.SDK.WXMsgImplComm"
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     const-string v1, "ignore wechat app signature validation"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;// 
a=0;//     invoke-static {p0, v0, p2}, Lcom/tencent/mm/sdk/openapi/WXApiImplComm;->validateAppSignature(Landroid/content/Context;[Landroid/content/pm/Signature;Z)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
