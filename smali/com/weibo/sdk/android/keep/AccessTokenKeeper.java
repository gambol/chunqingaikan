package com.weibo.sdk.android.keep; class AccessTokenKeeper { void a() { int a;
a=0;// .class public Lcom/weibo/sdk/android/keep/AccessTokenKeeper;
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/weibo/sdk/android/keep/AccessTokenKeeper;);
a=0;//     return-void
a=0;// .end method
a=0;// 
