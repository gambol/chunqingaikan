package com.twocloooo; class DevNativeActivity$9 { void a() { int a;
a=0;// .class Lcom/twocloooo/DevNativeActivity$9;
...
a=0;//     .locals 0
a=0;// 
a=0;//     iput-object p1, p0, Lcom/twocloooo/DevNativeActivity$9;->a:Lcom/twocloooo/DevNativeActivity;
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloooo/DevNativeActivity$9;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
