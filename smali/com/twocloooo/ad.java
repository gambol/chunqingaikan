package com.twocloooo; class ad { void a() { int a;
a=0;// .class Lcom/twocloooo/ad;
...
a=0;//     .locals 0
a=0;// 
a=0;//     iput-object p1, p0, Lcom/twocloooo/ad;->a:Lcom/twocloooo/v;
a=0;// 
a=0;//     iput-object p2, p0, Lcom/twocloooo/ad;->b:Landroid/app/AlertDialog;
a=0;// 
a=0;//     iput-object p3, p0, Lcom/twocloooo/ad;->c:Lcom/twocloooo/ay;
a=0;// 
a=0;//     iput-object p4, p0, Lcom/twocloooo/ad;->d:Landroid/content/Context;
a=0;// 
a=0;//     iput-object p5, p0, Lcom/twocloooo/ad;->e:Ljava/lang/String;
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/twocloooo/ad;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .locals 5
a=0;// 
a=0;//     iget-object v0, p0, Lcom/twocloooo/ad;->b:Landroid/app/AlertDialog;
a=0;// 
a=0;//     #v0=(Reference,Landroid/app/AlertDialog;);
a=0;//     invoke-virtual {v0}, Landroid/app/AlertDialog;->dismiss()V
a=0;// 
a=0;//     iget-object v0, p0, Lcom/twocloooo/ad;->c:Lcom/twocloooo/ay;
a=0;// 
...
a=0;// 
a=0;//     iget-object v3, p0, Lcom/twocloooo/ad;->c:Lcom/twocloooo/ay;
a=0;// 
...
a=0;// 
a=0;//     iget-object v1, p0, Lcom/twocloooo/ad;->d:Landroid/content/Context;
a=0;// 
...
a=0;//     iget-object v0, p0, Lcom/twocloooo/ad;->d:Landroid/content/Context;
a=0;// 
a=0;//     #v0=(Reference,Landroid/content/Context;);
a=0;//     const-string v1, "xp_click"
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
a=0;//     iget-object v2, p0, Lcom/twocloooo/ad;->c:Lcom/twocloooo/ay;
a=0;// 
...
a=0;//     iget-object v3, v3, Lcom/twocloooo/ay;->g:Ljava/lang/String;
a=0;// 
a=0;//     iget-object v4, p0, Lcom/twocloooo/ad;->e:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     iget-object v0, p0, Lcom/twocloooo/ad;->a:Lcom/twocloooo/v;
a=0;// 
...
a=0;// 
a=0;//     #v2=(Reference,Lcom/twocloooo/ay;);
a=0;//     iget-object v3, p0, Lcom/twocloooo/ad;->e:Ljava/lang/String;
a=0;// 
a=0;//     #v3=(Reference,Ljava/lang/String;);
