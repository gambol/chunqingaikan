package com.twocloooo; class bm { void a() { int a;
a=0;// .class public Lcom/twocloooo/bm;
a=0;// .super Ljava/lang/Object;
a=0;// 
a=0;// 
a=0;// # direct methods
a=0;// .method static a(Landroid/content/Context;I)Ljava/lang/String;
a=0;//     .locals 4
a=0;// 
a=0;//     const-string v0, ""
a=0;// 
...
a=0;//     .locals 2
a=0;// 
a=0;//     const-string v0, "preferences"
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     const/4 v1, 0x0
a=0;// 
...
a=0;//     invoke-direct {v1, p0}, Ljava/lang/StringBuffer;-><init>(Ljava/lang/String;)V
a=0;// 
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     invoke-virtual {v0, v1}, Ljava/security/MessageDigest;->digest([B)[B
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {v0}, Lcom/twocloooo/bm;->a([B)Ljava/lang/String;
a=0;//     :try_end_0
a=0;//     .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
a=0;// 
a=0;//     move-result-object v0
...
a=0;//     const-string v0, "00000000000000000000000000000000"
a=0;// 
a=0;//     goto :goto_0
a=0;// .end method
a=0;// 
a=0;// .method static declared-synchronized a(Ljava/util/Collection;)Ljava/lang/String;
a=0;//     .locals 2
a=0;// 
a=0;//     const-class v0, Lcom/twocloooo/bm;
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method static a(Ljava/util/HashMap;)Ljava/lang/String;
a=0;//     .locals 1
a=0;// 
a=0;//     new-instance v0, Lorg/json/JSONObject;
a=0;// 
a=0;//     #v0=(UninitRef,Lorg/json/JSONObject;);
a=0;//     invoke-direct {v0, p0}, Lorg/json/JSONObject;-><init>(Ljava/util/Map;)V
a=0;// 
...
a=0;// 
a=0;//     :cond_2
a=0;//     #v3=(Integer);v4=(Integer);v6=(One);
a=0;//     move v2, v3
a=0;// 
a=0;//     move v3, v4
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method static a(Landroid/content/Context;Ljava/lang/String;)Z
a=0;//     .locals 2
a=0;// 
a=0;//     const/4 v0, 0x1
a=0;// 
...
a=0;// 
a=0;//     #v1=(Reference,Landroid/content/pm/PackageManager;);
a=0;//     invoke-virtual {v1, p1, v0}, Landroid/content/pm/PackageManager;->getPackageArchiveInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
a=0;// 
a=0;//     move-result-object v1
a=0;// 
...
a=0;// 
a=0;//     :goto_2
a=0;//     #v1=(Integer);v2=(Integer);v5=(Conflicted);v6=(Conflicted);
a=0;//     if-lt v1, v7, :cond_2
a=0;// 
...
a=0;// 
a=0;//     :cond_0
a=0;//     #v0=(Null);v2=(Uninit);v5=(Uninit);v6=(Uninit);
a=0;//     aput v1, v3, v1
a=0;// 
...
a=0;// 
a=0;//     :cond_3
a=0;//     #v0=(Short);v6=(Conflicted);
a=0;//     add-int/lit8 v1, v1, 0x1
a=0;// 
a=0;//     rem-int/lit16 v1, v1, 0x100
a=0;// 
a=0;//     aget v5, v3, v1
a=0;// 
a=0;//     add-int/2addr v2, v5
...
a=0;//     aget v6, v3, v2
a=0;// 
a=0;//     rem-int/lit16 v6, v6, 0x100
a=0;// 
a=0;//     add-int/2addr v5, v6
a=0;// 
a=0;//     rem-int/lit16 v5, v5, 0x100
a=0;// 
a=0;//     aget v5, v3, v5
a=0;// 
...
a=0;// 
a=0;//     :goto_0
a=0;//     #v0=(Reference,Ljava/lang/String;);v1=(Boolean);v3=(Conflicted);v4=(Conflicted);
a=0;//     if-eqz v1, :cond_1
a=0;// 
a=0;//     sget-object v0, Lcom/twocloooo/bb;->T:Ljava/lang/String;
a=0;// 
a=0;//     :cond_1
a=0;//     :goto_1
a=0;//     return-object v0
...
a=0;// 
a=0;//     const-string v3, "000000000000000"
a=0;// 
...
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     invoke-static {p0, p1, v0}, Lcom/twocloooo/bm;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     return-object v0
a=0;// .end method
a=0;// 
a=0;// .method static b(Ljava/lang/String;)Ljava/lang/String;
a=0;//     .locals 5
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {v2}, Lcom/twocloooo/bm;->e(Ljava/lang/String;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v1
a=0;// 
a=0;//     invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
a=0;// .end method
a=0;// 
a=0;// .method static c(Ljava/lang/String;)Ljava/lang/String;
a=0;//     .locals 5
a=0;// 
...
a=0;//     invoke-direct {v0, v3}, Ljava/lang/String;-><init>([C)V
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     return-object v0
a=0;// 
a=0;//     :cond_0
a=0;//     #v0=(Integer);
a=0;//     aget-char v4, v2, v0
a=0;// 
a=0;//     #v4=(Char);
a=0;//     aput-char v4, v3, v1
a=0;// 
a=0;//     add-int/lit8 v1, v1, 0x1
a=0;// 
...
a=0;// .end method
a=0;// 
a=0;// .method static c(Landroid/content/Context;Ljava/lang/String;)Ljava/util/LinkedList;
a=0;//     .locals 4
a=0;// 
...
a=0;//     invoke-static {p0, p1}, Lcom/twocloooo/bm;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v1
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/String;);
...
a=0;//     :cond_1
a=0;//     :try_start_0
a=0;//     #v1=(Reference,Ljava/lang/String;);v2=(Boolean);v3=(Reference,Ljava/lang/String;);
...
a=0;// 
a=0;//     invoke-virtual {v2, v1}, Lorg/json/JSONArray;->get(I)Ljava/lang/Object;
a=0;// 
a=0;//     move-result-object v3
a=0;// 
...
a=0;//     move-result-object v3
a=0;// 
a=0;//     invoke-static {v3}, Lcom/twocloooo/au;->a(Ljava/lang/String;)Lcom/twocloooo/au;
a=0;// 
a=0;//     move-result-object v3
a=0;// 
a=0;//     invoke-virtual {v0, v3}, Ljava/util/LinkedList;->add(Ljava/lang/Object;)Z
a=0;//     :try_end_0
...
a=0;// 
a=0;//     #v1=(One);
a=0;//     invoke-static {p0}, Lcom/twocloooo/bm;->e(Landroid/content/Context;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;// .end method
a=0;// 
a=0;// .method static d(Ljava/lang/String;)Ljava/util/HashMap;
a=0;//     .locals 5
a=0;// 
...
a=0;// 
a=0;//     :goto_1
a=0;//     #v0=(Reference,Ljava/util/HashMap;);v2=(Conflicted);v3=(Conflicted);
a=0;//     return-object v0
a=0;// 
a=0;//     :cond_0
a=0;//     #v0=(Boolean);v2=(Reference,Lorg/json/JSONObject;);v3=(Reference,Ljava/util/Iterator;);
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {v2, v0}, Lorg/json/JSONObject;->get(Ljava/lang/String;)Ljava/lang/Object;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     check-cast v0, Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v4, v0}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
a=0;//     :try_end_0
a=0;//     .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
a=0;// 
a=0;//     goto :goto_0
...
a=0;// .end method
a=0;// 
a=0;// .method static d(Landroid/content/Context;Ljava/lang/String;)Ljava/util/LinkedList;
a=0;//     .locals 4
a=0;// 
a=0;//     new-instance v0, Ljava/util/LinkedList;
a=0;// 
...
a=0;//     move-result-object v3
a=0;// 
a=0;//     invoke-static {v3}, Lcom/twocloooo/ax;->a(Ljava/lang/String;)Lcom/twocloooo/ax;
a=0;// 
a=0;//     move-result-object v3
a=0;// 
a=0;//     invoke-virtual {v0, v3}, Ljava/util/LinkedList;->add(Ljava/lang/Object;)Z
...
a=0;//     iget v5, v3, Landroid/util/DisplayMetrics;->densityDpi:I
a=0;// 
a=0;//     #v5=(Integer);
...
a=0;//     iget v0, v0, Landroid/content/res/Configuration;->screenLayout:I
a=0;// 
a=0;//     #v0=(Integer);
...
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/StringBuilder;);
a=0;//     iget v6, v3, Landroid/util/DisplayMetrics;->widthPixels:I
a=0;// 
a=0;//     #v6=(Integer);
a=0;//     invoke-virtual {v0, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {v0}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;
...
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/StringBuilder;);
a=0;//     iget v3, v3, Landroid/util/DisplayMetrics;->heightPixels:I
a=0;// 
a=0;//     #v3=(Integer);
...
a=0;// 
a=0;//     #v0=(UninitRef,Ljava/lang/StringBuilder;);
a=0;//     sget-object v7, Lcom/twocloooo/bb;->S:Ljava/lang/String;
a=0;// 
...
a=0;// 
a=0;//     invoke-direct {v0, v7}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/StringBuilder;);
a=0;//     const-string v7, "="
a=0;// 
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     invoke-static {p0}, Lcom/twocloooo/bm;->c(Landroid/content/Context;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v2
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->Y:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->Z:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->aa:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->ab:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;//     move-result-object v2
a=0;// 
a=0;//     invoke-virtual {v2}, Ljava/util/Locale;->getLanguage()Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v2
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->W:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->am:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     invoke-static {p0}, Lcom/twocloooo/bb;->c(Landroid/content/Context;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v2
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->ad:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v2=(One);
a=0;//     invoke-static {p0, v2}, Lcom/twocloooo/bm;->a(Landroid/content/Context;I)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v2
a=0;// 
a=0;//     #v2=(Reference,Ljava/lang/String;);
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->ae:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->af:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->ag:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->ah:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/StringBuilder;);
a=0;//     sget-object v2, Lcom/twocloooo/bb;->ai:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     sget-object v2, Lcom/twocloooo/bb;->aj:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     invoke-static {p0}, Lcom/twocloooo/bc;->b(Landroid/content/Context;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v2
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     sget-object v2, Lcom/twocloooo/bb;->an:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;//     move-result-object v1
a=0;// 
a=0;//     sget-object v2, Lcom/twocloooo/bb;->ac:Ljava/lang/String;
a=0;// 
a=0;//     invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
a=0;// 
a=0;//     move-result-object v1
...
a=0;// 
a=0;//     :cond_0
a=0;//     #v1=(Boolean);v2=(Reference,Ljava/lang/String;);v3=(Reference,Ljava/lang/String;);v4=(Reference,Ljava/lang/String;);v5=(Reference,Ljava/lang/String;);v6=(Reference,Ljava/lang/String;);v7=(Reference,Ljava/lang/String;);
a=0;//     new-instance v1, Ljava/lang/StringBuilder;
a=0;// 
a=0;//     #v1=(UninitRef,Ljava/lang/StringBuilder;);
a=0;//     invoke-static {v0}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;
...
a=0;// 
a=0;//     :catch_1
a=0;//     #v1=(Conflicted);v2=(Conflicted);v3=(Reference,Ljava/lang/String;);v4=(Reference,Ljava/lang/String;);v5=(Reference,Ljava/lang/String;);v6=(Reference,Ljava/lang/String;);v7=(Reference,Ljava/lang/String;);
a=0;//     move-exception v1
a=0;// 
a=0;//     #v1=(Reference,Ljava/lang/Exception;);
a=0;//     goto :goto_0
...
a=0;// 
a=0;//     :cond_1
a=0;//     #v0=(Integer);v1=(Null);v2=(Reference,[Landroid/net/NetworkInfo;);v3=(Integer);
